...
class vBCms_ContentManager
{
	...
	****************/
	public static function getSectionList($orderby = 1)
	{
		...
		//This is a fairly complex task. Most of the time we want the unsorted version,
		//so let's cache that.
		if ($orderby == 1)
		{
			$result = vB_Cache::instance()->read('admin_sectionlist_unsorted_' . vB_Template_Runtime::fetchStyleVar('right'), false, true) ;
			if ($result)
			{
				return $result;
			}
		...
		if (!$sortable)
		{
			...
			vB_Cache::instance()->write('admin_sectionlist_sortable', $result, 1440, array('sections_updated'));
		}
		...
		if ($orderby == 1)
		{
			vB_Cache::instance()->write('admin_sectionlist_unsorted_' . vB_Template_Runtime::fetchStyleVar('right'), $result, 1440, array('sections_updated'));
		}
		return $result;
	...
	*********/
	...
	<div id=\"category_title_controls\" style=\"height:640px;width:600px;\">" . $vbphrase['enter_a_category_title'] .
	...
	<div id=\"section_picker_controls\" style=\"height:640px;width:600px;\">
		...
		<div class=\"picker_overlay\" id=\"catedit_section_list\" style=\"height:340px;width:620px;" . vB_Template_Runtime::fetchStyleVar('left') . ":5px;top:95px;overflow:auto;position:absolute;display:block;\">
	";
	...
	<div id=\"category_selector\" style=\"position:absolute;width:330px;" . vB_Template_Runtime::fetchStyleVar('left') . ":350px\">
		...
		<div id=\"catedit_category_list\" style=\"height:345px;width:340px;" . vB_Template_Runtime::fetchStyleVar('left') . ":5px;top:50px;overflow:auto;position:absolute;display:block;border-style:solid;border-width:1px 1px 1px 1px;\">
