...
$upgradecore_phrases['backup_after_upgrade'] = '<p class="smallfont">Backups must be run prior to the upgrade, if the upgrade is complete please use the Admin Control Panel.</p>
		<p class="smallfont">For a foolproof backup, login to your server via Telnet or SSH and use the <i>mysqldump</i>
		command on the command line. For more details,
		<a href="_blank">read this</a>.</p>';
$upgradecore_phrases['eaccelerator_too_old'] = 'eAccelerator for PHP must be upgraded to 0.9.3 or newer. Please view this <a href="showthread.p' . 'hp?p=979044#post979044">Post</a> for more information.';
...
$upgradecore_phrases['mmcache_not_supported'] = 'Turck MMCache has been made obsolete by eAccelerator and does not function properly with vBulletin. Please view this <a href="showthread.p' . 'hp?p=979044#post979044">Post</a> for more information.';
