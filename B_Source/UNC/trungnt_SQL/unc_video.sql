...
--
-- Host: localhost
-- Generation Time: Nov 08, 2012 at 03:01 AM
...
CREATE TABLE IF NOT EXISTS `unc_video` (
  ...
  `thumbnail` varchar(2000) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  ...
  `category_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `unc_video` (`video_id`, `video_title`, `video_alias`, `video_description`, `video_link`, `thumbnail`, `is_active`, `video_full_link`, `youtube_id`, `user_upload`, `category_id`, `is_default`, `viewer_number`) VALUES
...
(120, 'Never change', 'Never-change', 'never change', '-wDcwDx6VBs', '', 0, 'http://www.youtube.com/watch?v=-wDcwDx6VBs', 2, '', '4', 0, 0),
...
(130, 'Long hổ môn', 'Long-ho-mon', 'Chung tử đơn', '/unc/video/file_1352025543.FLV', '<p><input type="image" src="/unc/userfiles/image/Penguins.jpg" width="1024" height="768" />&nbsp;</p>', 1, NULL, NULL, 'admin', '1', 0, 0),
(131, 'hoạt hình heo còi', 'hoat-hinh-heo-coi', 'ko có mô tả nào ', '/unc/video/file_1352277695.flv', '<p><img width="200" height="150" src="/unc/userfiles/image/Koala.jpg" alt="" /></p>', 1, NULL, NULL, 'admin', '3,4,5,6', 0, 0),
(132, 'hoạt hình vui nhộn', 'hoat-hinh-vui-nhon', 'Ho hoạt hình vui nhộn', '/unc/video/file_1352339848.mp4', '<p><img src="http://localhost/unc/application/templates/admin/js/fckeditor/editor/images/smiley/msn/devil_smile.gif" alt="" /></p>', 1, NULL, NULL, 'admin', '2,3,5,6', 0, 0);
