<?php
	class Admin extends Admin_Controller
	{
		...
		function insert()
		{
			...
			{
				$data['list']=$this->Mdanhmuc->getListByColumn('mc_category','parent_id','0');
			...
			else 
			{
				...
				{
					$input=$this->_input();
					if ($this->Mdanhmuc->insertNewRow('mc_category',$input))
					{
		...
		function edit($id=0)
		{
			...
			{
				$data['list']=$this->Mdanhmuc->getListByColumn('mc_category','parent_id','0');
				$data['info']=$this->Mdanhmuc->getRowByColumn('mc_category','id',$id);
			...
			else 
			{
				...
				{
					$input=$this->_input();
					if ($this->Mdanhmuc->updateRowByColumn('mc_category','id',$id,$input))
					{
		...
		{
			if ($this->Mdanhmuc->deleteRowByColumn('mc_category','id',$id))
			{
