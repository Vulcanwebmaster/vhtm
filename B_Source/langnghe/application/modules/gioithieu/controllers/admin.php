<?php
	class Admin extends Admin_Controller
	{
		...
		function page($index=0)
		{
			...
			$config['per_page']=15;
			$config['total_rows']=count($this->Mgioithieu->getListFull('gioithieu'));
			$config['uri_segment']=4;
			$this->pagination->initialize($config);
			
			$data['title']='Tin tức';
			$data['bcCurrent']='tin tức';
			//$data['list_lienhe']=$this->Mgioithieu->getListlienhe();
			$data['list']=$this->Mgioithieu->getListOffset('gioithieu',15,$index);
