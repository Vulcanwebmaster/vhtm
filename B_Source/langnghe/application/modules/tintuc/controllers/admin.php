	...
	class Admin extends Admin_Controller
	{
		...
		function insert()
		{
			...
			else 
			{
				...
				{
					$input=$this->_input();
					if ($this->Mtintuc->insertNewRow('ln_news',$input))
					{
		...
		function edit($id=0)
		{
			...
			if (!$this->input->post('news_title'))
			{
				$data['info']=$this->Mtintuc->getRowByColumn('ln_news','news_id',$id);
			...
			else 
			{
				...
				{
					$input=$this->_input();
					if ($this->Mtintuc->updateRowByColumn('ln_news','news_id',$id,$input))
					{
		...
		{
			if ($this->Mtintuc->deleteRowByColumn('ln_news','news_id',$id))
			{
