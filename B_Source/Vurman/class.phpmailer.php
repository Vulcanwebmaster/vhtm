...
<title>Contact Form Perfect Funds Solutions Ltd</title>

<META name="keywords" content="Contact Form, TA, Transfer-Agent, Hedgefunds, Offshorefunds, Fund Settlement, Subscription, Redemption">
<META name="description" content="Contact Form, TA, Transfer-Agent, Hedgefunds, Offshorefunds, Fund Settlement, Subscription, Redemption">
...
<div style="width:605px; margin:0px auto;text-align:left;">
<img src="ZEIT8.jpg" style="float:right;width:605px; height:185px;" /></div>
   ...
   <td><input class="norm"  type="text" name="telefon" id="telefon" value="<?php echo $telefon; ?>"/></td>
    <td>Fax</td>
     <td><input class="norm"  type="text" name="fax" id="fax" value="<?php echo $fax; ?>"/></td>
       ...
       <input name="messagetopic" type="radio" value="Database" <?php if ($messagetopic == "Database") echo "checked=checked"; ?>/>Database&nbsp;
       <input name="messagetopic" type="radio" value="Transfer" <?php if ($messagetopic == "Transfer") echo "checked=checked"; ?>/>Transfer&nbsp;
       <input name="messagetopic" type="radio" value="Trading" <?php if ($messagetopic == "Trading") echo "checked=checked"; ?>/>Trading&nbsp;
       <input name="messagetopic" type="radio" value="Client Access" <?php if ($messagetopic == "Client Access") echo "checked=checked"; ?>/>Client Access&nbsp;
   </fieldset>
  </div>
