      ...
      <legend>CLIENT DETAILS</legend>
       <table align="center">
        <tr>
         ...
         <td align="left"><input class="norm" type="text" name="Client-ID" id="Client-ID" value="<?php echo $_SESSION['login']; ?>" readonly="readonly" style="width:80px" /></td>         
        ...
        <tr>
	         ...
	         <td colspan="4" align="left"><input name="Client" type="text" id="Client" style="width:242px;" readonly="readonly" <?php if(sizeof($arrUser1)){ echo "value='".$arrUser1[0]['name']."'";} ?> /></td>
        </tr>
       </table>
      </fieldset>
</div>
   ...
   <legend>SUBSCRIPTION ORDER - DETAILS</legend>
    <table class="contab" align="center">
     <tr>
       ...
       <td align="left"><input type="text" id="security2" class="norm" name="security2" onChange="GetFundName2()" />
       </td>
       
       <td align="right" style="color:red;">CURRENCY*</td>
      <td align="left">
       <input name="currency2" type="text" id="currency2" style="width:50px;" class="norm" /><input type="hidden" name="currency_hid2" id="currency_hid2" value="" />
      </td>
     </tr>
     <tr>   
      <td align="right">FUND NAME</td>
