...
function pageselectCallback(page_index, jq){
	...
	var newcontent = '';	var color="#f5f5f5";
	
	// Iterate through a selection of the content and build an HTML string
	 
	for(var i=page_index*items_per_page;i<max_elem;i++)
	{		if(color=="#f5f5f5") 			color="#cccccc";		else if(color=="#cccccc")				color="#f5f5f5";
		//alert(i);
		...
		newcontent += '<td style="text-align:center;">' + JSONCustodian[i].custodian + '</td>';		newcontent += '<td  style="text-align:center;">' + JSONCustodian[i].biccust + '</td>';		newcontent += '<td  style="text-align:center;">' + JSONCustodian[i].cpacwithcust + '</td>';		
				newcontent+="</tr>";												
	}
       ...
       <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
        <table id="searchtable" width="600" border="0" cellspacing="1" cellpadding="2">
         <tr>
          <th align="right">ID</th>
           <td align="left">
            <input name="search_id" type="text" id="search_id" size="3" /></td>
             
          <th align="right">CP-ID</th>
           <td align="left">   
            <input name="search_cpid" type="text" id="search_cpid" size="3" /></td>            
      
           <th align="right">COUNTERPARTY</th>
            <td align="left"><input name="search_counterparty" type="text" id="search_counterparty" size="15" /></td> 
          ...
          <tr>
           <th align="right">CUST.-ID</th>
            <td align="left">   
             <input name="search_custid" type="text" id="search_custid" size="3" /></td>               
      	
      	   <th align="right">CUST.</th> 
      	    <td align="left"><input name="search_custodian" type="text" id="search_custodian" size="15" /></td>	
      	    	
      	  <th align="right" >BIC (CUST.)</th> 
      	   <td align="left"><input name="search_biccust" type="text" id="search_biccust" size="15" /></td>  
      	  </tr>
      	   
      	  <tr>
      	   <th align="right">CP-A/C-CUST.</th>
      	    <td align="left"><input name="search_cpacwithcust" type="text" id="search_cpacwithcust" size="10" /></td>
      	   
           <td colspan="8" align="right">
            <input type="submit" name="Search" id="Search" value="SEARCH" />
            <input type="button" id="create-custodian" value="ADD NEW" /></td>
           </tr>
          </table>
	 </form>
        </fieldset>
    	...
    	<div id="users-contain" class="ui-widget"  style="clear:both; float:left; margin:0px; padding:0px; padding-top:5px;">
         <div id="Searchuser">This content will be replaced when pagination inits.</div>
          <table id="users" width="600" class="ui-widget ui-widget-content">
           <thead>
            <tr class="ui-widget-header ">
             <th style="text-align: center; width: 150px;">ID</th>
              <th style="text-align: center; width: 150px;">COUNTERPARTY - ID</th>
           <!--<th>COUNTERPARTY</th>-->
                <th style="text-align: center; width: 150px;">COUNTERPARTY NAME</th>                        
                 <th style="text-align: center; width: 150px;" >BIC (COUNTERPARTY)</th>
                </tr>
                
            <tr class="ui-widget-header ">  
             <th style="text-align: center; width: 150px;">CUSTODIAN-ID</th>  
          <!--<th>CUSTODIAN</th>-->      
               <th style="text-align: center; width: 150px; ">CUSTODIAN NAME</th>
               	<th style="text-align: center; width: 150px;">BIC (CUSTODIAN)</th> 
               	 <th  style="text-align: center; width: 150px;">CP A/C WITH CUST</th>  
               	</tr>
               </thead>
              <tbody>
             </tbody>
