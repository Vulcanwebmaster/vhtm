...
function pageselectCallback(page_index, jq){
	...
	for(var i=page_index*items_per_page;i<max_elem;i++)
	{		if(color=="#f5f5f5") 			color="#cccccc";		else if(color=="#cccccc")				color="#f5f5f5";
		...
		newcontent += '<td style="text-align:center;">' + JSONCustodian[i].custodian + '</td>';		newcontent += '<td  style="text-align:center;">' + JSONCustodian[i].biccust + '</td>';		newcontent += '<td  style="text-align:center;">' + JSONCustodian[i].cpacwithcust + '</td>';		
            ...
            <table id="users" class="ui-widget ui-widget-content">
                <thead>
                    <tr class="ui-widget-header ">
                        ...
                        <!--<th>COUNTERPARTY</th>-->                        <th style="text-align: center; width: 160px;">NAME COUNTERPARTY</th>                        
                        <th style="text-align: center; width: 160px;" >BIC (COUNTERPARTY)</th>
                    </tr>
                    <tr class="ui-widget-header ">                    	<th style="text-align: center; width: 160px;">CUSTODIAN-ID</th>                        <!--<th>CUSTODIAN</th>-->                        <th style="text-align: center; width: 160px; ">NAME CUSTODIAN</th>
