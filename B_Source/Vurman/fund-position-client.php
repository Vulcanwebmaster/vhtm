  ...
  <fieldset>
   <legend>SHOW BOOKINGS ONLY</legend>
    <table class="contab">
     ...
     <tr><td align="right"><span style='color:#FF0000'>A/C NUMBER*</span></td>  
      ...
      <center>FIELDS MARKED WITH AN ASTERISK * ARE MANDATORY<br/>
        ...
        <div id="right">
            <div class="menucontainer">
                <p class="menutitle">
                    CASH ACCOUNT(S)</p>
                <a class="menu" href="bank-ac.php" onfocus="blur()">CASH ACCOUNT(S)</a>                
            </div>
            <div class="menucontainer">
                <p class="menutitle">
                    FUND POSITION(S)</p>
                <a class="menu" href="fund-position.php" onfocus="blur()">FUND TRACKING</a>
                <a class="menu" href=".html" onfocus="blur()">FUND PORTFOLIO</a>                
            </div>
            <div class="menucontainer">
                <p class="menutitle">
                    HELP DESK / SUPPORT</p>
                <a class="menu" href="contact-menu.php" target="_top" onfocus="blur()">CONTACT FORM</a>
