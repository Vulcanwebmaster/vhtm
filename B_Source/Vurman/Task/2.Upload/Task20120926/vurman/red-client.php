      ...
      <legend>CLIENT DETAILS</legend>
       <table align="center">
        ...
        <tr>
	         ...
	         <td colspan="4" align="left"><input name="Client" type="text" style="width:242px;" id="Client" readonly="readonly" <?php if(sizeof($arrUser1)){ echo "value='".$arrUser1[0]['firstname']."'";} ?> /></td>
        </tr>
       </table>
      </fieldset>
