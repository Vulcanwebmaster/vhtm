...
Class UserClass extends ChildCoreClass
{
	...
	function SearchUser()
	{
		...
		if($this->cellphone!="")		{			$whereQuery.=$and."cell like '".$this->cellphone."%'";			$and=" and ";		}
	...
	function DeleteUser()
	{
		...
		unset($InsArr['email']);
		unset($InsArr['first_name']);				unset($InsArr['last_name']);
		unset($InsArr['active']);
		unset($InsArr['gender']);
