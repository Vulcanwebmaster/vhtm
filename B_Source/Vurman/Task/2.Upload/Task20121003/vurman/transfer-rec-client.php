      ...
      <legend>CLIENT DETAILS</legend>
       ...
       <table  align="center">
        ...
        <tr>
         ...
         <td align="left"><input name="Client-ID" type="text" class="norm" id="Client-ID" style="width:80px;" value="<?php echo $_SESSION['login']; ?>" readonly="readonly" /></td>         
        ...
        <tr>
	         ...
	         <td colspan="4" align="left"><input name="Client" type="text" id="Client" style="width:242px;" readonly="readonly" <?php if(sizeof($arrUser1)){ echo "value='".$arrUser1[0]['first_name'].' '.$arrUser1[0]['last_name']."'";} ?> /></td>
  ...
  <fieldset id="fieldsetFundDetails" style="display:all;">
   ...
   <legend>FUND DETAILS</legend>
    ...
    <table  align="center">    
     ...
     <tr><td align="right"><span style='color:#FF0000'>ISIN*</span></td>
       ...
       <td>
         ...
         <!--<select name='security1' id="security1" onchange='GetFundName()'>
           ...
           <?php 
...

			{
...

				{
					...
					echo "<option value=\"".$arrISIN[$i]['id']."\">".$arrISIN[$i]['code']."</option>";
    ...
    <tr>
     ...
     <td colspan="3" align="left"><input class="norm" type="text" name="comment" style="width:105px;" id="comment" /></td>
    ...
    <tr>
     <td align="right">SELLER A/C WITH CUST.</td>
      <td align="left" colspan="4"><input class="norm" type="text" name="client_ac_cust" id="client_ac_cust"/>
     </td>
    </tr>
