            ...
            <table id="users" class="ui-widget ui-widget-content" style="width: 710px;">
                <thead>
                    <tr class="ui-widget-header ">
                        ...
                        <th style="text-align: center; width: 150px;">CLIENT-ID</th>                        						<th style="text-align: center; width: 150px;">LOGIN ID</th>												 <th style="text-align: center; width: 150px;">PASSWORD</th>                      
                       
                    </tr>
                    <tr class="ui-widget-header "  >
                       <th style="width: 150px; text-align: center;">FIRST NAME</th>                                                <th style="width: 150px; text-align: center;" >LAST NAME</th>                                                <th style="width: width: 150px; text-align: center;" >DEPARTMENT</th>                                                <th style="text-align: center;width: 150px;">GENDER</th>                                           <!-- <th>PHONE</th>-->					</tr>					<tr class="ui-widget-header ">						                      	<th style="text-align: center; width: 150px;">CELLPHONE</th>                      	                      	<th style="text-align: center; width: 150px;">E-MAIL</th>							
