...
<head>
    ...
    <script type="text/javascript" src="js/appointment-cal-admin.js"></script>
...
<tr>
  ...
  <td width="120" colspan="2" align="center"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?year=<?php echo $prevYear; ?>&month=<?php echo $prevMonth; ?>">PREV. MONTH</a></td>

  <td width="180" colspan="3" align="center" style="font-weight:normal; text-transform:uppercase;"><?php
  ...
  <td width="120" colspan="2" align="center"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?year=<?php echo $nextYear; ?>&month=<?php echo $nextMonth; ?>">NEXT MONTH</a></td>
...
<tr>
  ...
  <th class="availabledate">MO</th>

  <th class="availabledate">TU</th>

  <th class="availabledate">WE</th>

  <th class="availabledate">TH</th>

  <th class="availabledate">FR</th>
...

			 {
				 ...
				 if($diffDate>=2)
					...
					echo "<td id=\"div$i\" onclick=\"showAppointment('$eventId');\" class='greencolor' width='90'>$i</td>";
				 	...
				 	echo "<td id=\"div$i\" onclick=\"showApproveAppointment('$eventId');\" class='datepassgreencolor' width='90'>$i</td>";
