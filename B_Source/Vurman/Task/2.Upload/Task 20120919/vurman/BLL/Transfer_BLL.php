...
Class TransferClass extends ChildCoreClass
{
	...
	function GetTransferUsingJSON()
	{
		...
		foreach($resArr as $item)
		{
			$JsonStr.=$comma."{";
			$JsonStr.="\"id\":\"".$item['id']."\",";
			$JsonStr.="\"client_id\":\"".$item['client_id']."\",";
			$JsonStr.="\"reference\":\"".$item['reference']."\",";						$JsonStr.="\"client_name\":\"".$item['reference']."\",";
			$JsonStr.="\"isin\":\"".$item['isin']."\",";
			$JsonStr.="\"fund_name\":\"".$item['fund_name']."\",";
			$JsonStr.="\"currency\":\"".$item['currency']."\",";
			$JsonStr.="\"quantity\":\"".$item['quantity']."\",";
			$JsonStr.="\"custody_ac\":\"".$item['custody_ac']."\",";
			$JsonStr.="\"trade_date\":\"".$item['trade_date']."\",";
			$JsonStr.="\"value_date\":\"".$item['value_date']."\",";
			$JsonStr.="\"counterparty_id\":\"".$item['counterparty_id']."\",";
			$JsonStr.="\"counterparty_name\":\"".$item['counterparty_name']."\",";
			$JsonStr.="\"bic_counterparty\":\"".$item['bic_counterparty']."\",";
			$JsonStr.="\"custodian_id\":\"".$item['custodian_id']."\",";
			$JsonStr.="\"custodian_name\":\"".$item['custodian_name']."\",";
			$JsonStr.="\"bic_custodian\":\"".$item['bic_custodian']."\",";
			$JsonStr.="\"counterparty_ac_custodian\":\"".$item['counterparty_ac_custodian']."\",";
			$JsonStr.="\"transfer_agent_name\":\"".$item['transfer_agent_name']."\",";
			$JsonStr.="\"bic_transfer_agent\":\"".$item['bic_transfer_agent']."\",";
			$JsonStr.="\"custodian_ac_transfer_agent\":\"".$item['custodian_ac_transfer_agent']."\",";
			...
			$JsonStr.="\"unknown_isin\":\"".$item['unknown_isin']."\"";
			$JsonStr.="}";
			$comma=",";
		}
		$JsonStr.="];</script>";
