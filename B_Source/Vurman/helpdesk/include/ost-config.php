...
define('SECRET_SALT','B7781191168902D');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','spicemaster@gmx.ch');

#Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','localhost'); 
define('DBNAME','web1244_helpdesk');
define('DBUSER','web1244_helpdesk');
define('DBPASS',';]i[(vLkOT6D');
