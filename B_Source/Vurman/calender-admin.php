...
<thead>
<tr>
  <td width="120" colspan="2" align="center"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?year=<?php echo $prevYear; ?>&month=<?php echo $prevMonth; ?>">PREVIOUS MONTH</a></td>
  <td width="180" colspan="3" align="center"><h3 style="font-weight:normal; text-transform:uppercase;"><?php
		$test= $monthName;;
		$test.= ", ";
    	$test.= $year;
		echo $test;
