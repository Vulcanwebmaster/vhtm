...
<head>
	...
	if($_SESSION['usertype']=="user")
			{
	?>
     <script type="text/javascript" src="js/open-trade-client.js"></script>
     <?php
			}
			else if($_SESSION['usertype']=="admin")
			{
	?>
     <script type="text/javascript" src="js/open-trade-admin.js"></script>
     <?php
			}
	 ?>
...
<?php 
	...
	$objTransfer->status_settle="pending";
...
<input type='hidden' name='type' value='purchase'/>        
     ...
     <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
        ...
        <?php require_once('include/trade-order-details.php'); ?>
        </form>
    </div>
