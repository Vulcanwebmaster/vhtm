  ...
  <fieldset class="fldset">
   <legend>CUSTODIAN INFORMATION</legend><br>
    <table width="590px" border="0">
     ...
     <tr>
      <td class="fieldset"><div class="tbl_lbl">KEY CONTACT PERSON</div><div class="tbl_input"><?php if(isset($custArr) && sizeof($custArr)>0) echo $custArr[0]["key_contact_person_a"]; ?>
 ...
 <fieldset class="fldset">
   <legend>TRANSFER AGENT INFORMATION</legend><br>
    <table width="590px" border="0">
     ...
     <tr>
      <td class="fieldset"><div class="tbl_lbl">KEY CONTACT PERSON</div><div class="tbl_input"><?php if(isset($transferArr) && sizeof($transferArr)>0) echo $transferArr[0]["key_contact_person_a"]; ?>
        <?php if(isset($transferArr) && sizeof($transferArr)>0) echo ' '.$transferArr[0]["key_contact_person_b"]; ?>
      </div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">E-MAIL ADDRESS</div><div class="tbl_input"><?php if(isset($transferArr) && sizeof($transferArr)>0) echo $transferArr[0]["email_address_a"]; ?>
        <?php if(isset($transferArr) && sizeof($transferArr)>0) echo ' '.$transferArr[0]["email_address_b"]; ?>
      </div></td>
     </tr>
