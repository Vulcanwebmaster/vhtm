  ...
  <fieldset id="fieldsetFundDetails" style="display:all;">
   ...
   <table align="center">
     <tr>
       ...
       <td><input type="text" name="security1" id="security1" value="" style="width:115px;"></td>
       </tr>
     </table>
  </fieldset>
...
?>  
     ...
     <tr>
      <td class="fieldset"><div class="tbl_lbl">PERFORMANCE YTD</div><div class="tbl_input"><?php if(isset($investment_detail) && sizeof($investment_detail)>0)  echo $investment_detail[0]["performance_ytd"]; ?></div></td>
         ...
         <tr>
           <td class="fieldset"><div class="tbl_lbl">ADDITIONAL INFORMATION</div>
             <div class="tbl_input">
               <?php if(isset($fundArr) && sizeof($fundArr)>0) echo $fundArr[0]["add_info_b"]; ?>
             </div></td>
         </tr>
       </table>
       </fieldset>
   ...
   <legend>INVESTMENT DETAILS (SUBSCRIPTION)</legend><br>
    <table width="590px" border="0">
     ...
     <!--Additional Information-->
      <tr>
      <td class="fieldset"><div class="tbl_lbl"><strong>ADDITIONAL INFORMATION</strong></div></td>
     </tr>
     <tr>
  ...
  <fieldset class="fldset">
   <legend>REDEMPTION DETAILS</legend><br>
    <table width="590px" border="0">
     <tr>
      <td class="fieldset"><div class="tbl_lbl">MINIMUM AMOUNT</div><div class="tbl_input"><?php if(isset($redArr) && sizeof($redArr)>0) echo $redArr[0]["minimum_amount"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">MINIMUM UNITS</div><div class="tbl_input"><?php if(isset($redArr) && sizeof($redArr)>0) echo $redArr[0]["minimum_units"]; ?></div></td>
     </tr>
     ...
     <tr>
      <td class="fieldset"><div class="tbl_lbl">CUT-OFF TIME</div><div class="tbl_input"><?php if(isset($redArr) && sizeof($redArr)>0) echo $redArr[0]["cut_of_time"]; ?></div></td>
     </tr>
  ...
  <fieldset class="fldset">
   <legend>REDEMPTION FEES</legend><br>
    <table width="590px" border="0">
     <tr>
      <td class="fieldset"><div class="tbl_lbl">MINIMUM BACK END FEE</div><div class="tbl_input"><?php if(isset($redFeeArr) && sizeof($redFeeArr)>0) echo $redFeeArr[0]["minimum_back_end_fee"]; ?></div></td>
     </tr>
 
     <tr>
      <td class="fieldset"><div class="tbl_lbl">MAXIMUM BACK END FEE</div><div class="tbl_input"><?php if(isset($redFeeArr) && sizeof($redFeeArr)>0) echo $redFeeArr[0]["maximum_back_end_fee"]; ?></div></td>
     </tr>
  ...
  <fieldset class="fldset">
   <legend>CUSTODIAN INFORMATION</legend><br>
    <table width="590px" border="0">
     ...
     <tr>
      <td class="fieldset"><div class="tbl_lbl">KEY CONTACT PERSON</div><div class="tbl_input"><?php if(isset($custArr) && sizeof($custArr)>0) echo $custArr[0]["key_contact_person_a"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">E-MAIL ADDRESS</div><div class="tbl_input"><?php if(isset($custArr) && sizeof($custArr)>0) echo $custArr[0]["email_address_a"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">KEY CONTACT PERSON</div><div class="tbl_input"><?php if(isset($custArr) && sizeof($custArr)>0) echo $custArr[0]["key_contact_person_b"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">E-MAIL ADDRESS</div><div class="tbl_input"><?php if(isset($custArr) && sizeof($custArr)>0) echo $custArr[0]["email_address_b"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">PHONE</div><div class="tbl_input"><?php if(isset($custArr) && sizeof($custArr)>0) echo $custArr[0]["phone_number"]; ?></div></td>
     </tr>
 ...
 <fieldset class="fldset">
   <legend>TRANSFER AGENT INFORMATION</legend><br>
    <table width="590px" border="0">
     ...
     <tr>
      <td class="fieldset"><div class="tbl_lbl">POSTAL ADDRESS</div><div class="tbl_input"><?php if(isset($transferArr) && sizeof($transferArr)>0) echo $transferArr[0]["postal_address_a"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">POSTAL ADDRESS</div><div class="tbl_input"><?php if(isset($transferArr) && sizeof($transferArr)>0) echo $transferArr[0]["postal_address_b"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">ZIP / CITY</div><div class="tbl_input"><?php if(isset($transferArr) && sizeof($transferArr)>0) echo $transferArr[0]["zip_city"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">KEY CONTACT PERSON</div><div class="tbl_input"><?php if(isset($transferArr) && sizeof($transferArr)>0) echo $transferArr[0]["key_contact_person_a"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">E-MAIL ADDRESS</div><div class="tbl_input"><?php if(isset($transferArr) && sizeof($transferArr)>0) echo $transferArr[0]["email_address_a"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">KEY CONTACT PERSON</div><div class="tbl_input"><?php if(isset($transferArr) && sizeof($transferArr)>0) echo $transferArr[0]["key_contact_person_b"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">E-MAIL ADDRESS</div><div class="tbl_input"><?php if(isset($transferArr) && sizeof($transferArr)>0) echo $transferArr[0]["email_address_b"]; ?></div></td>
     </tr>
  ...
  <fieldset class="fldset">
   <legend>FUND ADVISOR INFORMATION</legend><br>
    <table width="590px" border="0">
     ...
     <tr>
      <td class="fieldset"><div class="tbl_lbl">POSTAL ADDRESS</div><div class="tbl_input"><?php if(isset($fundAdvArr) && sizeof($fundAdvArr)>0) echo $fundAdvArr[0]["postal_address_a"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">POSTAL ADDRESS</div><div class="tbl_input"><?php if(isset($fundAdvArr) && sizeof($fundAdvArr)>0) echo $fundAdvArr[0]["postal_address_b"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">ZIP / CITY</div><div class="tbl_input"><?php if(isset($fundAdvArr) && sizeof($fundAdvArr)>0) echo $fundAdvArr[0]["zip_city"]; ?></div></td>
     </tr>
     ...
     <tr>
      <td class="fieldset"><div class="tbl_lbl">E-MAIL ADDRESS</div><div class="tbl_input"><?php if(isset($fundAdvArr) && sizeof($fundAdvArr)>0) echo $fundAdvArr[0]["email_address"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">PHONE</div><div class="tbl_input"><?php if(isset($fundAdvArr) && sizeof($fundAdvArr)>0) echo $fundAdvArr[0]["phone_number"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">FAX</div><div class="tbl_input"><?php if(isset($fundAdvArr) && sizeof($fundAdvArr)>0) echo $fundAdvArr[0]["fax_number"]; ?></div></td>
     </tr>
      </table>
       </fieldset>
  ...
  <fieldset class="fldset">
   <legend>FUND AUDITOR INFORMATION</legend><br>
    <table width="590px" border="0">
     ...
     <tr>
      <td class="fieldset"><div class="tbl_lbl">POSTAL ADDRESS</div><div class="tbl_input"><?php if(isset($fundAudArr) && sizeof($fundAudArr)>0) echo $fundAudArr[0]["postal_address_a"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">POSTAL ADDRESS</div><div class="tbl_input"><?php if(isset($fundAudArr) && sizeof($fundAudArr)>0) echo $fundAudArr[0]["postal_address_b"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">ZIP / CITY</div><div class="tbl_input"><?php if(isset($fundAudArr) && sizeof($fundAudArr)>0) echo $fundAudArr[0]["zip_city"]; ?></div></td>
     </tr>
     ...
     <tr>
      <td class="fieldset"><div class="tbl_lbl">E-MAIL ADDRESS</div><div class="tbl_input"><?php if(isset($fundAudArr) && sizeof($fundAudArr)>0) echo $fundAudArr[0]["email_address"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">PHONE</div><div class="tbl_input"><?php if(isset($fundAudArr) && sizeof($fundAudArr)>0) echo $fundAudArr[0]["phone_number"]; ?></div></td>
     </tr>
     
     <tr>
      <td class="fieldset"><div class="tbl_lbl">FAX</div><div class="tbl_input"><?php if(isset($fundAudArr) && sizeof($fundAudArr)>0) echo $fundAudArr[0]["fax_number"]; ?></div></td>
     </tr>
      </table>
       </fieldset>
<?php
