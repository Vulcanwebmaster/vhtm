...
<thead>
<tr>
	<td colspan="2" align="center"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?year=<?php echo $prevYear; ?>&month=<?php echo $prevMonth; ?>">PREVIOUS MONTH</a></td>
	<td colspan="3" align="center"><h3 style="font-weight:normal; text-transform:uppercase;"><?php
		$test= $monthName;;
		$test.= ", ";
    	$test.= $year;
		echo $test;
...
<tr>
<th  width='60' class="weekend">SU</th>
<th  width='60' class="availabledate">MO</th>
<th  width='60' class="availabledate">TU</th>
<th  width='60' class="availabledate">WE</th>
<th  width='60' class="availabledate">TH</th>
<th  width='60' class="availabledate">FR</th>
