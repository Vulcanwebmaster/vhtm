      ...
      <legend>CLIENT DETAILS</legend>
       ...
       <table  align="center">
        ...
        <tr>
	         ...
	         <td colspan="4" align="left"><input name="Client" type="text" id="Client" style="width:242px;" readonly="readonly" <?php if(sizeof($arrUser1)){ echo "value='".$arrUser1[0]['firstname'].' '.$arrUser1[0]['lastname']."'";} ?> /></td>
