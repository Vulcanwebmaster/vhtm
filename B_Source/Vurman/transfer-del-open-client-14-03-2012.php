...
<head>
    ...
    <script type="text/javascript" src="js/open-transfer-client.js"></script>
...
<input type='hidden' name='type' value='purchase'/>        
     ...
     <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
   	   <?php require_once("include/search-transfers-client.php"); ?>
        <?php require_once('include/search-result-table.php'); ?>
        <?php require_once('include/order-details-del.php'); ?>
        </form>
    </div>
