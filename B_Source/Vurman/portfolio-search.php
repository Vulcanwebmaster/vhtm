...
<span id="error" style="display:none; color:#F00; border:0px solid #fff;">&nbsp;</span>
  ...
  <fieldset>
   ...
   <div style="clear:both;">
    ...
    <fieldset>
     ...
     <input style="float:center; font-size:11px;" name="view_transaction" type="submit" value="VIEW TRANSACTION(S)" onclick="return check_portfolio_search();" />
...
<br/>
    ...
    <fieldset>
        ...
        <table align="left"  class="ui-widget ui-widget-content contab" style="margin-left:3px; width:189px"">
    ...
    <fieldset>
        ...
        <tr class="ui-widget-header ">
          ...
          <th align="center" style="text-align: center" width="20%">CREDIT(S)</th>

          <th align="center" style="text-align: center" width="30%">CUSTODY A/C</th>

          <th align="center" style="text-align: center" width="25%">REFERENCE</th>

          <th align="center" style="text-align: center" width="25%">VALUE DATE</th>
        ...
        <tr>
          ...
          <td align="right" style="text-align:right"><?php echo $arrFundPortFolio[$i]['credit']; ?></td>

          <td align="center" style="text-align:center"><?php echo GetCustodyACName($arrCustodyAC,$arrFundPortFolio[$i]['custody_ac']); ?></td>

          <td align="center" style="text-align:center"><?php echo $arrFundPortFolio[$i]['credit_ref']; ?></td>

          <td align="center" style="text-align:center"><?php echo formatdate($arrFundPortFolio[$i]['credit_date']); ?></td>
    ...
    <fieldset>
	    ...
	    <table width="575" align="center" class="ui-widget ui-widget-content">
	      ...
	      <tr class="ui-widget-header ">
	        ...
	        <th align="center" style="text-align: center" width="20%">DEBIT(S)</th>
