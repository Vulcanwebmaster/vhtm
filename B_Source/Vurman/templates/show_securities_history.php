...
<td width='25%'>
      <?php if($number > 0){?>
       <a href='show_securities_history.php?number=0'>Current</a>
      <?php } ?>
</td>
<td width='25%'>
      <?php if($number > 0){?>
       <a href='show_securities_history.php?number=<?php echo ($number-1) ?>'>Next</a>
      <?php } ?>
</td>
<td width='25%'>
      <?php if($number < $total){?>
       <a href='show_securities_history.php?number=<?php echo ($number+1) ?>'>Previous</a>
      <?php } ?>
</td>
<td width='25%'>
      <?php if($number < $total){?>
       <a href='show_securities_history.php?number=<?php echo $total ?>'>Very first</a>
      <?php } ?>
</td>
</tr></table>
