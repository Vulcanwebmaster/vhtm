...
--
-- Host: localhost
-- Generation Time: Aug 28, 2012 at 08:03 AM
...
(14, 1, 'CUSTODIAN ABC', '11', 0, '20.123.456', 'TAABC456XXX', '1881'),
(15, 0, 'UBS AG', '101', 0, '230-12786.S1', 'REICCH22XXX', 'hihi'),
(35, 0, 'Hiep ga', '', 1, '2', '', ''),
(36, 696, 'FPT', 'AbC', 3, 'Hiep', 'XyZ', 'Nothing'),
(37, 3, 'a', 'Ã¡dfasdf', 3, 'd', 'a', 'a');
...
(42, '', '', '', '', '', '', 'hjh', 0, '0000-00-00', '', '', '', '', '', '', '', '', '0000-00-00', '0', '', '', '', '0000-00-00', '', '', 35, 35, 33, 35, '2012-06-26 20:40:39', 13);
...
INSERT INTO `settlement_instruction` (`id`, `seller_id`, `name`, `bic`, `custodianid`, `custodian`, `biccustodian`, `acwithcust`, `transferagent`, `bicta`, `acwithta`) VALUES
...
(1, 'peihnav', 'hiepga223', 'hiepnv@fsoft.com.vn', '0438889999', '0988889998', '0983392169', 'November', 'Rain', 'Developer', 'user', '0', 1),
(2, 'ruby', 'hiepga223', 'bichngoc.nong@viettinbank.vn', '032009898', '0973558146', '0', 'Mat', 'To', 'Banking', 'user', '1', 1),
(3, 'hiepga', 'hiepga223', 'aba@gmail.com', '0', '0', '0', 'GEIGERPBXXX', 'GEIGER ', '', 'user', '', 1),
(4, '4', '3', 'a', '0', '0', '0', 'BHSCHAEFXXX', 'BANKHAUS SCHAEFER', NULL, 'user', '1', 0),
(5, 'sascha', 'handle', 'vahi4ever@gmail.com', '0', '0', '0', 'HANDLEPBXXX', 'HANDLE ', '', 'user', '0', 123),
