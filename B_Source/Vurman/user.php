...
if(isset($_POST['Search']) && $_POST['Search']=="SEARCH"){	if(isset($_POST['search_id']) && $_POST['search_id']!=""){
	...
	if(isset($_POST['search_department']) && $_POST['search_department']!=""){
		...
		$objUser->gender=$_POST['search_officephone'];
...
<body onload="loadAll();">
    ...
    <div id="main_cont">
        ...
        <div id="title"><img src="logo.jpg" alt="" /></div>
        ...
        <div id="content" style="margin-left: 72px;">
         <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
          <fieldset style="border:1px solid #CCC; width:660px; margin:0px; padding:0px;" >
   	   <legend>USER MANAGEMENT</legend>
        <!-- Sắp xếp thứ tự trình bày các thuộc tính USER MÂNGEMENT và bỏ PHONE NO-->
            <table id="searchtable" width="650" border="0" cellspacing="1" cellpadding="2">
             <tr>	
              <th align="right" width="5%">ID</th>
               <td align="left" width="5%">	
               	<input name="search_id" type="text" id="search_id" size="5" /></td>
               		
              <th align="right">CLIENT-ID</th>
               <td align="left">
               	<input name="search_clientid" type="text" id="search_clientid" size="5" /></td>
               		
              <th align="right">LOGIN-ID</th>
               <td align="left">
               	<input name="search_loginid" type="text" id="search_loginid" size="10" /></td>
               		
              <th align="right">PASSWORD</th>
               <td align="left">
               	<input name="search_password" type="text" id="search_password" size="10" /></td>
               </tr>	
               	
             <tr>
              <th align="right" width="15%">FIRST NAME</th>
               <td align="left" width="15%">	
               	<input name="search_firstname" type="text" id="search_firstname" size="10" /></td>
               		
              <th align="right" width="15%">LAST NAME</th>	
               <td align="left" width="15%">	
               	<input name="search_lastname" type="text" id="search_lastname" size="15" /></td>
               	
              <th align="right" width="15%">COMPANY</th>	
               <td align="left" width="15%">	
               	<input name="search_company" type="text" id="search_company" size="25" /></td>
               		
              <th align="right" width="15%">DEPARTMENT</th>	
               <td align="left" width="15%">	
               	<input name="search_department" type="text" id="search_department" size="10" /></td>
               </tr>
             ...
             <tr>  					
              ...
              <th align="right">E-MAIL</th>	
               <td align="left">	
               	<input name="search_email" type="text" id="search_email" size="25" /></td>               		
              	
              <th align="left" >ACTIVE
               <select name="search_active" id="search_active" style="width: 50px;">	
               ...
               <th align="left">ROLE
                <select name="search_role" id="search_role" style=" width: 50px;"> 
              ...
              <tr>
               <td colspan="8" align="right">
                ...
                <input type="button" id="create-user" value="ADD NEW" />
               </td>
              </tr>
             </table>
	    </form>
       ...
       <!--Hoang- Customize table--like remaning work vurman.com-->
    	<div id="users-contain" class="ui-widget" style=" width: 660px; clear:both; float:left; margin:0px; padding:0px; padding-top:5px;">
         <div id="Searchuser">This content will be replaced when pagination inits.</div>
          <table id="users" class="ui-widget ui-widget-content" style="width: 660px;">
           <thead>
            <tr class="ui-widget-header ">
             ...
             <th style="text-align: center; width: 150px;">LOGIN-ID</th>												 <th style="text-align: center; width: 150px;">PASSWORD</th>                      
            </tr>
            ...
            <tr class="ui-widget-header "  >
             ...
             <th style="width: width: 150px; text-align: center;" >COMPANY</th> 
        ...
        <!-- <th>PHONE</th>-->	
            ...
            <tr class="ui-widget-header ">
             ...
             <th style="text-align: center; width: 150px;">ACTIVE</th>
              
             <th style="text-align: center; width: 150px;">ROLE</th>
            </tr>
           </thead>
         ...
         <p id="validateTips">FIELDS MARKED WITH AN ASTERISK * ARE MANDATORY</p>
          <fieldset>
           <table width="400" border="0" cellspacing="0" cellpadding="0"> 
            ...
            <tr>
             <th align="right" valign="middle">ROLE<span class="red">*&nbsp;&nbsp;&nbsp;</span></th>
            ...
            <tr>
             <th align="right" valign="middle">ACTIVE<span class="red">*&nbsp;&nbsp;&nbsp;</span></th>
              <td align="left"><input name="rduseractive" type="radio" id="rduseractive_0" checked="checked" value="1"  style="float:left;" />YES
