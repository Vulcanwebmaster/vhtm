...
<form name='createT' method='post' action=''>
 ...
 <br>
  ...
  <fieldset class="fldset">
   ...
   <select name='transfer_agent_id' onchange='SetValues_transfer_agent(this.value,true)'>
<option value='0'><?php echo 'Select transfer_agent';?></option>
<?php foreach($transfer_agents as $transfer_agent){ ?>
<option value='<?php echo $transfer_agent['id'];?>' <?php if(trim($_POST['transfer_agent_id']) == $transfer_agent['id']) echo"selected = 'selected'" ?>><?php echo $transfer_agent['id'];?></option>
<?php } ?>
</select>
...
<select name='custodian_id' onchange='SetValues_custodian(this.value,true)'>
<option value='0'><?php echo 'Select custodian';?></option>
<?php foreach($custodians as $custodian){ ?>
<option value='<?php echo $custodian['id'];?>' <?php if(trim($_POST['custodian_id']) == $custodian['id']) echo"selected = 'selected'" ?>><?php echo $custodian['id'];?></option>
<?php } ?>
</select>
...
<select name='fund_advisor_id' onchange='SetValues_fund_advisor(this.value,true)'>
<option value='0'><?php echo 'Select fund_advisor';?></option>
<?php foreach($fund_advisors as $fund_advisor){ ?>
<option value='<?php echo $fund_advisor['id'];?>' <?php if(trim($_POST['fund_advisor_id']) == $fund_advisor['id']) echo"selected = 'selected'" ?>><?php echo $fund_advisor['id'];?></option>
<?php } ?>
</select>
...
<select name='fund_auditor_id' onchange='SetValues_fund_auditor(this.value,true)'>
<option value='0'><?php echo 'Select fund_auditor';?></option>
<?php foreach($fund_auditors as $fund_auditor){ ?>
<option value='<?php echo $fund_auditor['id'];?>' <?php if(trim($_POST['fund_auditor_id']) == $fund_auditor['id']) echo"selected = 'selected'" ?>><?php echo $fund_auditor['id'];?></option>
<?php } ?>
</select>
