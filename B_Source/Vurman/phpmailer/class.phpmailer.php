...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
 <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de-ch" lang="de-ch">
  <head>
   <title>Perfect Banking Solutions</title>
    <meta name="author" content="Jan Vurma">
...
/* <![CDATA[ */ 
    ...
    alert("Sie k�nnen maximal 1000 Zeichen schreiben!\nBitte �ndern sie ihre Eingaben");
    }
    ...
    function checkInputs(){
        ...
        document.getElementById("errText").innerHTML="Bitte erg&auml;nzen Sie die rot markierten Felder"
        return false;
        }
        else{
...
<form action="javascript:alert('Formular gesendet!!')" method="post" onsubmit="return checkInputs();">
 <input type="hidden" name="recipient" id="recipient" value="spicemasta@gmx.de" />
  <input type="hidden" name="redirect" id="redirect" value="http://www.domain.com/index.html/danke_mail.html" />
   <div>
   ...
   <td><input class="norm"  type="text" name="telefon" id="telefon" value=""/></td>
    <td>Fax</td>
     <td><input class="norm"  type="text" name="fax" id="fax" value=""/></td>
      ...
      <input name="anfrage" type="radio" value="Buchhaltung" checked="checked"/>Buchhaltung&nbsp;
     <input name="anfrage" type="radio" value="Fondsadministration"/>Fondsadministration&nbsp;
    <input name="anfrage" type="radio" value="Wertschriften"/>Wertschriften&nbsp;
   </fieldset>
  </div>
 ...
 <div>
  <fieldset>
   <legend>Ihre Nachricht*</legend>
    ...
    <input style="float:right;" type="reset" value="L�schen" onclick="resetAll();"/> 
   </fieldset>
