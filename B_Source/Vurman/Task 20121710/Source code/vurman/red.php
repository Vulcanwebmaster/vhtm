...
$msg="";
	...
	if($clientid!="")
	{
		...
		$objTransfer->custody_ac=$_POST['custody_ac'];
 ...
 <head>
  <title>Vurman - Spectrum Funds</title>
   ...
   <meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
    ...
    <script type="text/javascript" language="javascript" src="js/redemption_order.js"></script>
      ...
      <legend>CLIENT DETAILS</legend>
       <table align="center">
        ...
        <tr>
         	...
         	<td  align="left"><input class="norm" name="Client" type="text" id="Client" style="width:150px;" readonly="readonly" /></td>
          	<td align="right">WORKER NAME</td>              
      	 	<td  align="left"><input class="norm" name="company" type="text" id="company" style="width:150px;" readonly="readonly" /></td>
         </tr>
        </table>
       </fieldset>
     ...
     <legend>REDEMPTION ORDER - DETAILS</legend>
      ...
      <tr>
       ...
       <td align="right" style="color:red;">CUSTODY A/C*</td>
        <td><select name="custody_ac" id="custody_ac" class="dropdown">
...
?>
   ...
   <fieldset>
    <input style="float:center;" type="submit" id="GetFund" name="GetFund" value="REDEMPTION" onclick='return verify();' />
   </fieldset>
