...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
  <tr>
    ...
    <td width="70" align="left" valign="top"><input name="client_id" type="text" id="client_id" size="10" style="width:80px;" value="<?php echo $_SESSION['login']; ?>" readonly="readonly"></td>
    ...
    <td width="100" align="left" valign="top"><input name='security1' id="security1" onchange='GetFundName()' />
     </td>
  </tr>
  <tr>
