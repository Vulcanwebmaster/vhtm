...
(function($) {
  ...
  $.fn.tweet = function(o){
    var s = {
      username: ["snowdentwit"],                // [string]   required, unless you want to display our tweets. :) it can be an array, just do ["username1","username2","etc"]
    ...
    return this.each(function(i, widget){
      var list = $('<ul class="tweet_list overview">').appendTo(widget);
