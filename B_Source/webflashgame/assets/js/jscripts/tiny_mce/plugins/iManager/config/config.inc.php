...
/*		array (
	...
	$cfg['ilibs'] 	= array (															// image library path with slashes; absolute from root directory e.g. '/pictures/'
		array (																		
			'value'   	=> '/leerobertsonx/assets/uploads/images/',												
			'text'    	=> 'images',
		),
		array (
			'value'   	=> '/leerobertsonx/assets/uploads/images/', 				
	...
	$cfg['ilibs_dir'] 	   = array('/leerobertsonx/assets/uploads/images/');						   	// image library path with slashes; absolute from root directory  e.g. '/pictures/' - please make sure that the directories have write permissions
