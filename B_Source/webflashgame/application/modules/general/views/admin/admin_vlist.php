		...
		function confirmDel(value)
				{
					...
					if (r==true)
					{
						var uri="<?php echo base_url()?>general/admin/delete/"+value;
						window.location=uri;
					}
					else 
					{
...
<form action="<?php echo base_url()?>general/admin/saveColumn1" method="post">    
					...
					<tbody>
					 	...
					 	{ $i++; ?>
					 		<tr><td><?php echo $i;?></td>
			    				...
			    				<td>
			    					<a href="<?php echo base_url()?>general/admin/edit/<?php echo $item->id?>" title="Edit"><img src="<?php echo base_url()?>assets/admin/images/icn_edit.png"></a>
			...
			<center style="font-size: 15px;color:red">
				...
				<footer>
						...
						<div class="submit_link">
							<a class="alt_btn" href="<?php echo base_url();?>general/admin/insert">Add new</a>
						</div>
				</footer>
