...
<script type="text/javascript">
		function confirmDel(value)
				{
					var x;
					var r=confirm("Bạn muốn xóa tài khoản này?");
					if (r==true)
					{
						var uri="<?php echo base_url()?>taikhoan/admin/delete/"+value;
						window.location=uri;
					}
					else 
					{
...
<form action="<?php echo base_url()?>taikhoan/admin/saveColumn1" method="post">    
					...
					<tbody>
					 	...
					 	{ $i++; ?>
					 		<tr><td><?php echo $i;?></td>
			    				...
			    				<td>
			    					<a href="<?php echo base_url()?>taikhoan/admin/edit/<?php echo $item->news_id?>" title="Sửa"><img src="<?php echo base_url()?>assets/admin/images/icn_edit.png"></a>
