			...
			<ul id="ullistnew">
				...
				<li>
					...
					<div class="textdetailnews">
						<p class="titlelistnews"><a href="<?php echo base_url();?>news/detail/<?php echo $value->id_news."-".$value->alias;?>">
						...
						<p class="readmordetailnews"><a href="<?php echo base_url();?>news/detail/<?php echo $value->id_news."-".$value->alias;?>">Read more</a></p>
					</div><br clear="both"/>
				</li>
				<?php }  ?>
			</ul>
