...
<!-- 									<a id="tournamentsReg" href="<?php echo base_url();?>setting/registAccount"><span>Register now!</span></a> -->
					...
					<div class="contBox topJackpot">
						<h3><?php if ($_SESSION['lang']=="fr"){
														 	echo 'Part du belote';
														 } else{
														 	echo 'Share of belote';
														  }?> </h3>
						<div class="container">
				...
				<div id="subNav" class="light">
					<ul>
						...
						<li id="btnTo3Rules" class=""><a rel="ax:/rules"><span><?php if ($_SESSION['lang']=="fr"){
														 	echo 'Règles tournoi';
														 } else{
			...
			<div id="tournamentSignOn" class="">
				...
				<?php 	 if(!$checkStatus){ ?>
					<form action="<?php echo base_url();?>giaidau/register" method="post" align="center">	
						...
						<button name="dkthamgiagiaidau" id="landingSend" value="<?php echo $_SESSION['front_user_id']?>" class="formButton fbSubmit"><span><?php if ($_SESSION['lang']=="fr"){
														 	echo 'Inscris-toi !';
														 } else{
														 	echo 'Register now!';
														  }?> </span></button>  
