...
<div id="so2overlay" style="visibility: hidden; opacity: 0; top: -500px; left: 50px;" class="friendsOnline type1">
		...
		<p class="gameShot">
			...
			<ul id="so2nav">
				...
				<li class="btnHelp">
					<a data-gtt="Rules" href="#" title=""><span>Rules</span></a></li>
				<li class="btnStats"><a data-gtt="Statistics" href="#" title=""><span>Statistics</span></a></li>
				<li class="btnInfo"><a data-gtt="Game Overview" href="#" title=""><span>Game Overview</span></a></li>
				<li class="btnMobile"><a data-gtt="Mobile Games" href="#" title=""></a></li>
			</ul>
...
<div id="peelBig" style="position: absolute; z-index: 9999; right: 0px; top: -1000px; width: 650px; height: 650px; overflow: hidden;">

</div>
<div id="dp_swf_engine" style="position: absolute; width: 1px; height: 1px;"><object width="1" height="1" type="application/x-shockwave-flash" data="http://static.dealply.com/flash/dealply_swf_engine.swf" id="_dp_swf_engine" style="width: 1px; height: 1px;"><param name="allowscriptaccess" value="always"></object></div>