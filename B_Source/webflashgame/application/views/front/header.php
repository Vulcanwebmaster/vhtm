<div id="header">
			...
			<div id="nav1">
				<ul>
				  ...
				  <li  id="menulaguages" class="active"><a href="#" style="height: 40px;"><span style="display: block; " class="lang_name">English (US)</span></a>
					<div  id="languages1" style="padding-top:5px; border-radius: 5px">
						<div><a href="#"><span style="display: block; " class="lang_name">English (US)</span></a></div>
