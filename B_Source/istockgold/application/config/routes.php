...
$route['news/tags/(:any)'] = 'welcome/allNewsWithTag/$1';
$route['news/(:any)'] = 'welcome/detailnews/$1';
$route['detailnews/(:any)'] = 'welcome/detailnews/$1';
$route['ajax_review'] = 'welcome/ajax_review';
$route['ajax_review/(:any)'] = 'welcome/ajax_review/$1';
$route['ajax_review_show'] = 'welcome/ajax_review_show';
$route['ajax_review_show/(:any)'] = 'welcome/ajax_review_show/$1';
...
$route['psuccess/(:any)'] = 'welcome/psuccess/$1';
$route['pcancel/(:any)'] = 'welcome/pcancel/$1';
$route['auth/(:any)'] = 'auth/$1';
$route['admin'] = 'admin/home';
$route['istockgold/admin'] = 'admin/home';
$route['(:any)/admin'] = '$1/admin';
$route['(:any)/admin/(:any)'] = '$1/admin/$2';
$route['(:any)/admin/(:any)/(:any)'] = '$1/admin/$2/$3';
