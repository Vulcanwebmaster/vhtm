...
<div id="admin_overview">
	...
	<div id="onebox"><?php print anchor('exchange_orders/admin','<img src="'.base_url().'assets/images/admin/n_order.png" width="16" height="16" border="0" />'.$this->lang->line('istockgold_exchanges_ordes')) ?>
	<br><b>Exchange orders managment (i.e order process, complete, pending...etc)</b></div>
</div>

<div id="admin_overview">
	<div id="title">Exchange parameters</div>
	<div id="onebox"><?php print anchor('exchange_rates/admin','<img src="'.base_url().'assets/images/admin/n_order_fee.png" width="16" height="16" border="0" />'.$this->lang->line('istockgold_exchange_rates')) ?>
	...
	<div id="onebox"><?php print anchor('site_currencies/admin','<img src="'.base_url().'assets/images/admin/n_currencies.png" width="16" height="16" border="0" />'.$this->lang->line('istockgold_site_currencies')) ?>
	<br><b>Update e-currencies account, passwords and ...</b></div>
</div>

<div id="admin_overview">
	<div id="title">Content management </div>
	<div id="onebox"><?php print anchor('news/admin','<img src="'.base_url().'assets/images/admin/n_ehistory.gif" width="17" height="17" border="0" />'.$this->lang->line('istockgold_news')) ?>
...
<div id="admin_overview">
	...
	<div id="onebox"><?php print anchor('manage_members/admin','<img src="'.base_url().'assets/images/admin/n_maccounts.gif" width="18" height="18" border="0" />'.$this->lang->line('istockgold_manage_members')) ?>
