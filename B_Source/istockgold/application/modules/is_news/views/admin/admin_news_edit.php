...
<form name="pages" id="pages" action="<?php echo base_url()?>index.php/is_news/admin/edit/<?php echo $news['id'];?>" 
  	...
  	<fieldset> 
			...
			<br>
			<input type="text" align="left" size="100%" name="title" id="title" value="<?php echo $news['title'];?>">
			</label>
			<label id="content_label"><span>Content:</span>
            <?php 
            $data = array('name'=>'content','id'=>'content','rows'=>'16', 'cols'=>'100%', 'value' => $news['content']);
