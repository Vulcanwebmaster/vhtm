...
class Admin extends Shop_Admin_Controller 
{
    ...
    function index()
    {
        ...
        $data['page'] = "admin/admin_news_home";
    ...
    */ 
    ...
    function common_home()
    {
        ...
        $orderby = array('date');
        $data['news'] = $this->MIStockGold->getAll("news",$fields,$orderby);
        return $data;
    }
    ...
    */
    ...
    function delete($id)
    {
        $this->MIStockGold->deleteitem("is_news",$id);
        redirect(base_url().'index.php/is_news/admin','refresh');
    }
}//end class
?>
