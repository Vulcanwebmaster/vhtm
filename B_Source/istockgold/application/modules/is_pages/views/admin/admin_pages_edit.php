...
<div id="page_title"><h1>Update Pages</h1></div> 
<form name="pages" id="pages" action="<?php echo base_url()?>index.php/is_pages/admin/edit/<?php echo $pages['id'];?>" 
		method="post" onsubmit="return CheckForm();">
  	<fieldset> 
			Update your pages by filling out the form below.
			<label id="lbl_error" class="ErrorMessage"></label>
			<label id="title_label"><span>Title<i> (required)</i>:</span>
			<br>
			<input type="text" align="left" size="100%" name="title" id="title" value="<?php echo $pages['title'];?>">
			</label>
			<label id="content_label"><span>Content:</span>
            <?php 
            $data = array('name'=>'content','id'=>'content','rows'=>'16', 'cols'=>'100%', 'value' => $pages['content']);
