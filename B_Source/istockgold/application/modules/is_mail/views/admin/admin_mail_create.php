...
<div id="page_title"><h1>Add Mail</h1></div> 
<form name="pages" id="pages" action="<?php echo base_url()?>index.php/is_mail/admin/create" 
		method="post" onsubmit="return CheckForm();">
			Add your mail by filling out the form below.
			<br>
