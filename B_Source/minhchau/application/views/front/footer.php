<div id="footer">
    ...
    <map name="Map">
       <area shape="rect" coords="78,45,312,119" href="<?php echo base_url();?>">
       <area shape="poly" coords="670,87,719,78,727,123,677,130" href="<?php echo base_url();?>">
       <area shape="poly" coords="776,124,818,152,793,189,751,160" href="<?php echo base_url();?>sanpham">
       <area shape="poly" coords="834,52,885,61,878,105,828,96" href="<?php echo base_url();?>dathang" title="Đặt hàng online">
	</map>