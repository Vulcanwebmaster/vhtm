...
--
-- Host: localhost
-- Generation Time: Nov 19, 2012 at 05:03 AM
...
(5, 'Thăm dò chức năng', 'Probe functionality', 'tham-do-chuc-nang', 0),
(6, 'Khoa mắt', 'ophthalmology', 'khoa-mat', 0),
(7, 'Khoa sản - Nhi', 'Department of Obstetrics', 'khoa-san-nhi', 0),
(8, 'Khoa tai - mũi - họng', 'Ear-nose-throat', 'khoa-tai-mui-hong', 0),
(9, 'Máy laser', 'laser machine', 'may-laser', 0),
(10, 'Nha Khoa', 'dentistry', 'Nha-Khoa', 0);
