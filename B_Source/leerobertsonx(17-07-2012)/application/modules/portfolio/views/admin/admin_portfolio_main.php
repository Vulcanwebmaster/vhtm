		...
		<div class="tab_container">
			...
			<?php foreach ($lst_categories as $rw):?> 
				<tr>  
    				...
    				<a href="<?php echo base_url()?>portfolio/admin/delCategory/<?php echo $rw->id?>" title="Edit"><img src="<?php echo base_url()?>assets/leerobertsonx_admin/images/icn_trash.png"></td> 
				</tr>
			<?php endforeach;?>
			</tbody> 
			</table>
