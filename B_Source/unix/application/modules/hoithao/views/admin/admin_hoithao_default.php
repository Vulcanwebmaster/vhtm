...
<form action="<?php echo base_url()?>index.php/hoithao/admin/update/<?php echo $hoithao->id;?>" method="post" onsubmit="return CheckForm();">
...
$data = array('name'=>'noidung','id'=>'noidung','rows'=>'30', 'cols'=>'80','value'=>$hoithao->noidung);
echo "<td id='nopad' >";
