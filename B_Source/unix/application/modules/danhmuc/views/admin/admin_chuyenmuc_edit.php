...
<form action="<?php echo base_url()?>index.php/danhmuc/admin/editChuyenMuc/<?php echo $chuyenmuc->id; ?>" method="post" onsubmit="return CheckForm();">
<?php
echo "\n<table id='preference_form'>";

echo "<tr><td class='label'><label>".'(*)'.' Tên chuyên mục:'."</label></td>\n";
$data = array('name'=>'ten','id'=>'ten','class'=>'text','value'=>$chuyenmuc->ten);
echo "<td>";
echo form_input($data);
echo "</td></tr>\n";

echo "<tr><td class='label'><label for='long'>".'(*) Nội dung chuyên mục:'."</label></td>\n";
$data = array('name'=>'noidung','id'=>'noidung','rows'=>'17', 'cols'=>'80','value'=>$chuyenmuc->noidung);
echo "<td id='nopad' >";
