...
class Admin_Controller extends NIW_Controller
{
	...
	function setupCKEditor($width='97%',$height='100px')
	{
		...
		$config['filebrowserBrowseUrl'] = base_url()."assets/5sao/ckeditor/ckfinder/ckfinder.html";
		$config['filebrowserImageBrowseUrl'] = base_url()."assets/5sao/ckeditor/ckfinder/ckfinder.html?type=Images";
		$config['filebrowserUploadUrl'] = base_url()."assets/5sao/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files";
		$config['filebrowserImageUploadUrl'] = base_url()."assets/5sao/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images";
		$config['toolbar']='Full';
		$config['width']=$width;
