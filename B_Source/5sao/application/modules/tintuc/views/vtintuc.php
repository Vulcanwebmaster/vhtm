		...
		{?>
			<li style="width:100%; float:left; border:1px solid #ddd; padding:5px 5px; margin:5px 0px;">
	            ...
	            <div class="aboutth-item" style="float:left; width:76%; height: 86px;">
	            	<h5><a href="<?php echo base_url();?>tintuc/detail/<?php echo $item->id;?>"><?php if ($_SESSION['lang']=="vn") echo strip_tags($item->tieude_v); else echo strip_tags($item->tieude_e);?></a></h5>
	            </div>
	  	    </li>
	  			<?php }?>
	</ul>
