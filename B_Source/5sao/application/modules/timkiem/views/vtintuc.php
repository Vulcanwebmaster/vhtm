		...
		<!--<li class="aboutus-item">
			...
			<div style="width:566px; float:left; border:1px solid #ddd; padding:5px 5px; margin:5px 0px;">
	            ...
	            <li class="aboutth-item">
	            	<h5><a href="<?php echo base_url();?>tintuc/detail/<?php echo $item->id;?>"><?php if ($_SESSION['lang']=="vn") echo strip_tags($item->tieude_v); else echo strip_tags($item->tieude_e);?></a></h5></br>
	            </li>
