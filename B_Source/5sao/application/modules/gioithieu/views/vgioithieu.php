...
<div id="center">
	<ul id="aboutus-menu">
		...
		<li class="aboutus-item">
			...
			<h3><a href="<?php echo base_url();?>gioithieu/detail/<?php echo $item->id;?>"><?php if ($_SESSION['lang']=="vn") echo strip_tags($item->tieude_v); else echo strip_tags($item->tieude_e);?></a></h3>
		</li>
		<?php }?>
	</ul>
</div>
