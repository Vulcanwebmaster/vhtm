...
--></style>
    <script src='<?php echo base_url();?>assets/women_files/jquery.min.js' type='text/javascript'></script>
	...
	<script type="text/javascript" src="<?php echo base_url();?>assets/js/shopcustomtools.js"></script>
	  ...
	  <!-- =======UNIFORM====== -->
	    ...
	    <script type="text/javascript" charset="utf-8">
	      $(function(){
	        $("#price-filter,#submit,#kho-filter,#submitKhoId").uniform();
	      });
	    </script>
	...
	<div>
		<div style="float:left">
			...
			<marquee style="float:left; width:500px" onmouseover="this.stop();" onmouseout="this.start();" scrollamount="3" behavior="scroll" style="width:98%; border-top:1px solid red;border-bottom:1px solid red; ">
				<p style="text-transform:none; color:orange">Tin khuyến mãi giảm giá 30% khi mua các sản phẩm từ ngày 14/5 đến 30/5</p>
			</marquee>
		</div>
		<div id="search">			
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-23906922-1']);
...
</script><script type="text/javascript" src="http://www.blogger.com/static/v1/widgets/3681494515-widgets.js"></script>
<script type="text/javascript">
...
_WidgetManager._RegisterWidget('_BlogView', new _WidgetInfo('Blog1', 'main', null, document.getElementById('Blog1'), {'cmtInteractionsEnabled': false, 'lightboxEnabled': true, 'lightboxModuleUrl': 'http://www.blogger.com/static/v1/jsbin/4157764637-lbx_vi.js', 'lightboxCssUrl': 'http://www.blogger.com/static/v1/v-css/228702327-lightbox_bundle.css'}, 'displayModeFull'));
</script>

<div id="crossrider-app-stub1950"></div>
</body>
</html>
