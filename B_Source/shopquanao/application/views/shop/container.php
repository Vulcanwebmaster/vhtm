...
<script type="text/javascript">
//<![CDATA[
Mage.Cookies.path     = '/casualwear';
Mage.Cookies.domain   = '.demo.emthemes.com';
//]]>
</script>
        ...
        <div class="header-container">
        	<!-- div class="header" -->
				...
				<?php $this->load->view($this->config->item('backendpro_template_shop') . 'navigation');?>
					...
					<div class="ajaxcart">
						<img class="ajax_loading" id="ajax_loading" src="women_files/loading.gif" alt="">
