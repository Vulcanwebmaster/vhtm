		...
		<div class="tab_container" >
			...
			<thead> 
				<tr> 
    				...
    				<th ><?php echo $this->lang->line('hocphi-admin-fee-name-vn');?></th>
    				<th ><?php echo $this->lang->line('hocphi-admin-fee-name-en');?></th> 
    				<th ><?php echo $this->lang->line('hocphi-admin-fee-decription-vn');?></th>
    				<th ><?php echo $this->lang->line('hocphi-admin-fee-decription-en');?></th> 
