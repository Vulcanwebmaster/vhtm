...
//==================================================================================================
//==================================================================================================
TransMenu.spacerGif = "x.gif"/*tpa=http://kcbonline.org/kcb1/kcb/modules//mod_ja_transmenu/ja_transmenu/img/x.gif*/;                     // path to a transparent spacer gif
TransMenu.dingbatOn = "arrow.png"/*tpa=http://kcbonline.org/kcb1/kcb/modules//mod_ja_transmenu/ja_transmenu/img/arrow.png*/;            // path to the active sub menu dingbat
TransMenu.dingbatOff = "tabarrow.png"/*tpa=http://kcbonline.org/kcb1/kcb/modules//mod_ja_transmenu/ja_transmenu/img/tabarrow.png*/;          // path to the inactive sub menu dingbat
...
TransMenu.shadowPng = "grey-40.png"/*tpa=http://kcbonline.org/kcb1/kcb/modules//mod_ja_transmenu/ja_transmenu/img/grey-40.png*/;               // a PNG graphic to serve as the shadow for mac IE5
TransMenu.backgroundColor = "#f5f6f8";                   // color of the background (transparency set in CSS)
TransMenu.backgroundPng = "white-90.png"/*tpa=http://kcbonline.org/kcb1/kcb/modules//mod_ja_transmenu/ja_transmenu/img/white-90.png*/;          // a PNG graphic to server as the background for mac IE5
