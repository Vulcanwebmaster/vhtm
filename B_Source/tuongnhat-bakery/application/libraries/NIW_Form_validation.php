 ...
 */
class NIW_Form_validation extends CI_Form_validation
{
	public $CI;
	...
	function valid_captcha()
	{
		...
		// Perform check
		return $this->CI->recaptcha->check_answer($this->CI->input->server('REMOTE_ADDR'), $this->CI->input->post('recaptcha_challenge_field'), $this->CI->input->post('recaptcha_response_field'));
	}
