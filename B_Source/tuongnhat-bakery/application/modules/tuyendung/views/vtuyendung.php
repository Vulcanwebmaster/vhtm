<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#tuyendung-menu a').addClass('active');
	});
</script>

<div class="breadcrumb">
	<a href="<?php echo base_url();?>"><?php echo $this->lang->line('menu-trangchu');?></a>
	&rsaquo; <?php echo $this->lang->line('menu-tuyendung');?>
</div>
...
<div>
	<ul style="list-style-type:none" class="list">
		...
		<li>
			...
			?>
			<a style="display: inline; color:#e19e2a" href="<?php echo base_url();?>tuyendung/detail/<?php echo $item->id;?>"> &rarr; Xem thêm</a>
		</li>
		<?php }?>
	</ul>
