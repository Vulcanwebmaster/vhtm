...
--
-- Host: localhost
-- Generation Time: Aug 27, 2012 at 10:20 PM
...
(1, 'Nguyên liệu lúa mỳ và các sản phẩm hữu cơ', 'Spelt wheat and organic products', '<p>\r\n	Nhu cầu cho c&aacute;c sản phẩm b&aacute;nh cao chất lượng v&agrave; thực phẩm hữu cơ đang gia tăng nhanh ch&oacute;ng. Spelt l&uacute;a m&igrave;, inparticular, iscurrently undergoinga phục hưng. Hạt n&agrave;y l&agrave; l&agrave;nh mạnh v&agrave; tăng cường mức độ hạnh ph&uacute;c, bởi v&igrave; n&oacute; rất gi&agrave;u c&aacute;c axit amin th&uacute;c đẩy việc sản xuất hormone trong cơ thể l&agrave;m tăng cảm gi&aacute;c hạnh ph&uacute;c. Ngo&agrave;i ra, n&oacute; l&agrave; một sức mạnh hạt thực v&igrave; n&oacute; c&oacute; chứa một hỗn hợp l&yacute; tưởng của kho&aacute;ng chất, vitamin, carbohydrate v&agrave; chất b&eacute;o cũng như chất xơ v&agrave; l&uacute;a m&igrave; proteins.Spelt l&agrave; một thực phẩm ho&agrave;n hảo cho những người c&oacute; neurodermatitis, dị ứng hoặc bệnh tiểu đường v&agrave; tất nhi&ecirc;n cho tất cả mọi người &yacute; thức về sức khỏe. Với lĩnh vực n&agrave;y của thị trường trong t&acirc;m tr&iacute; ch&uacute;ng t&ocirc;i đ&atilde; ph&aacute;t triển ổ b&aacute;nh l&uacute;a mạch đen cao chất lượng hữu cơ hỗn hợp v&agrave; một loạt c&aacute;c đ&aacute;nh vần mộc mạc l&uacute;a m&igrave; products.The cộc cằn h&igrave;nh tam gi&aacute;c c&oacute; l&uacute;a m&igrave; spenta, l&uacute;a m&igrave; spenta cuộn 85g cộc cằn v&agrave; l&uacute;a m&igrave; spenta crusty baguette 250g tay sản xuất v&agrave; nhiều th&agrave;nh phần dinh dưỡng của họ l&agrave; mang lại lợi &iacute;ch cho sức khỏe.</p>\r\n', '<p>\r\n	The demand for high-quality bakery products and organic food is increasing rapidly. Spelt wheat, inparticular, iscurrently undergoinga renaissance. This grain is healthy and boosts levels of well-being, because it is rich in amino acids that promote the production of hormones in the body that increase feelings of happiness. In addition, it is a real power-grain as it contains an ideal mixture of minerals, vitamins, carbohydrates and fats as well as dietary fibre and proteins.Spelt wheat is a perfect food for people with allergies, neurodermatitis or diabetes and of course for all health-conscious people. With this sector of the market in mind we have developed a high-quality organic mixed rye loaf and a range of rustic spelt wheat products.The crusty triangular spelt wheat roll, the 85g crusty spelt wheat roll and the 250g crusty spelt wheat baguette are hand-produced and their many nutritious ingredients are beneficial to health.</p>\r\n', '<p>\r\n	<img alt="" src="/ckfinder/userfiles/images/1.jpg" style="width: 240px; height: 190px;" /></p>\r\n'),
(2, 'Bánh mỳ que & Bánh mỳ ổ', 'Rolls, baguettes & loaves', '<p>\r\n	Cuộn tươi ngon từ l&ograve; với một lớp vỏ b&oacute;ng tốt, v&agrave; b&aacute;nh m&igrave; que sắc n&eacute;t với một b&ecirc;n trong mềm chỉ đơn giản l&agrave; delicious.We c&oacute; nhiều lựa chọn c&aacute;c ổ b&aacute;nh m&igrave; v&agrave; b&aacute;nh - kh&aacute;m ph&aacute; ra nhiều sản phẩm đa dạng của ch&uacute;ng t&ocirc;i.</p>\r\n', '<p>\r\n	Tasty rolls fresh from the oven with a fine, glossy crust and crisp baguettes with a soft inside are simply delicious.We have a wide selection of loaves and rolls &ndash; discover our varied product range.</p>\r\n', '<p>\r\n	<img alt="" src="/ckfinder/userfiles/images/2.jpg" style="width: 240px; height: 190px;" /></p>\r\n'),
(3, 'Bánh Địa Trung Hải', 'Mediterranean-style bakery products', '<p>\r\n	Sun, tiếng gầm của s&oacute;ng v&agrave; m&ugrave;i tươi nướng b&aacute;nh m&igrave; que với &ocirc; liu từ l&ograve; đ&aacute; n&agrave;y l&agrave; tinh khiết kỳ nghỉ mood.With b&aacute;nh m&igrave; ciabatta theo phong c&aacute;ch Địa Trung Hải của ch&uacute;ng t&ocirc;i, sắc n&eacute;t &quot;Rustiguette&quot; b&aacute;nh m&igrave; từ l&ograve; đ&aacute; hoặc tỏi tự nhi&ecirc;nb&aacute;nh m&igrave; từ l&ograve; đ&aacute;, bạn sẽ được thưởng thức kỳ nghỉ atmosphere.Rhombus shapedor đồng bằng hạt đa dạng cuộn, cuộn đ&ocirc;i với c&agrave; chua v&agrave; b&aacute;nh m&igrave; tr&ograve;n phổ biến ở Paris ra khỏi phạm vi sản phẩm.</p>\r\n', '<p>\r\n	Sun, the roar of the surf and the smell of freshly-baked baguettes with olives from the stone oven - this is pure holiday mood.With our Mediterranean-style ciabatta bread, the crisp &ldquo;Rustiguette&rdquo; baguette from the stone oven or the wild garlic baguette from the stone oven, you will simply taste the holiday atmosphere.Rhombus-shapedor plain multi-grain rolls, the double roll with tomatoes and the popular big Parisian baguette round off the product range.</p>\r\n', '<p>\r\n	<img alt="" src="/ckfinder/userfiles/images/3.jpg" style="width: 240px; height: 190px;" /></p>\r\n'),
(4, 'Bánh ngọt', 'Lye pastry', '<p>\r\n	test1</p>\r\n', '<p>\r\n	test 2</p>\r\n', '<p>\r\n	<img alt="" src="/ckfinder/userfiles/images/4.jpg" style="width: 240px; height: 190px;" /></p>\r\n'),
(5, 'Món khai vị', 'Savoury delicacies', '<p>\r\n	test 4</p>\r\n', '<p>\r\n	test 5</p>\r\n', '<p>\r\n	<img alt="" src="/ckfinder/userfiles/images/5.jpg" style="width: 240px; height: 190px;" /></p>\r\n'),
(6, 'Bánh sừng bò', 'Croissants', '<p>\r\n	test 7124</p>\r\n', '<p>\r\n	test 8124</p>\r\n', '<p>\r\n	<img alt="" src="/ckfinder/userfiles/images/6.jpg" style="width: 240px; height: 190px;" /></p>\r\n');
...
(1, 'admin', '0993abd18b04dce02cafde93878540f109592da5', 'admin@gmail.com', 1, 2, NULL, '2012-08-27 21:30:53', '2012-02-22 13:46:09', '2012-03-17 21:56:17'),
