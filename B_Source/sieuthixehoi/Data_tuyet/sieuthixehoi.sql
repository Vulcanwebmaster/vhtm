...
--
-- Host: localhost
-- Generation Time: Nov 26, 2012 at 09:50 AM
...
CREATE TABLE IF NOT EXISTS `n_oto_contacts` (
  ...
  `contact_name` varchar(132) COLLATE utf8_unicode_ci NOT NULL,
  `contact_email` varchar(132) COLLATE utf8_unicode_ci NOT NULL,
  `category_id` int(10) NOT NULL,
  `contact_subject` varchar(132) COLLATE utf8_unicode_ci NOT NULL,
  `contact_message` varchar(500) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'admin', '0993abd18b04dce02cafde93878540f109592da5', 'admin@gmail.com', 1, 2, NULL, '2012-11-26 08:26:21', '2012-02-22 13:46:09', '2012-03-17 21:56:17'),
