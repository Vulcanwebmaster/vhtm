...
<form method="post" action="<?php echo base_url();?>tuvansanpham/admin">
					 	...
					 	{?>
					 		<tr>  
			    				...
			    				<td>
				    				...
				    				<a href="<?php echo base_url()?>tuvansanpham/admin/delete/<?php echo $item->id?>" title="Del"><img src="<?php echo base_url()?>assets/admin/images/icn_trash.png"></a>
			    				</td>
							</tr>
					 	<?php }?>
					</tbody> 
			...
			<center style="font-size: 15px;color:red">
				...
				<footer>
						<div class="submit_link">
							<a class="alt_btn" href="<?php echo base_url();?>tuvansanpham/admin/insert">Thêm</a>
						</div>
				</footer>
