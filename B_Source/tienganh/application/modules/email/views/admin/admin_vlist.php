...
<script type="text/javascript">
		function confirmDel(value)
				{
					var x;
					var r=confirm("Bạn muốn xóa email này?");
					if (r==true)
					{
						var uri="<?php echo base_url()?>email/admin/delete/"+value;
						window.location=uri;
					}
					else 
					{
...
<form action="<?php echo base_url()?>email/admin/saveColumn1" method="post">    
