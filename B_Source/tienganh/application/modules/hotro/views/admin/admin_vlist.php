...
<script type="text/javascript">
		function confirmDel(value)
				{
					var x;
					var r=confirm("Bạn muốn xóa hỗ trợ này?");
					if (r==true)
					{
						var uri="<?php echo base_url()?>hotro/admin/delete/"+value;
						window.location=uri;
					}
					else 
					{
...
<form action="<?php echo base_url()?>hotro/admin/save" method="post">    
			...
			<center style="font-size: 15px;color:red">
				...
				<footer>
						...
						<div class="submit_link">
							<a class="alt_btn" href="<?php echo base_url();?>hotro/admin/insert">Thêm mới</a>
						</div>
				</footer>
