...
class Rss extends NIW_Controller
{
		...
		{
			$data['list_news'] = $this->Mrss->getListFull('ta_news');
			...
			echo "  <channel>\n";  
			echo "    <title>Trung tam tieng Anh</title>\n";  
			echo "    <link>linktrangchutrangweb.com</link>\n";  
			echo "    <description>Trung tam tieng Anh</description>\n";  
			echo "    <copyright>$copy_year Trung tam tieng Anh</copyright>\n";  
			echo "    <generator>Trung tam tieng Anh</generator>\n";  
			echo "    <language>vietnamese</language>\n";  
			...
			foreach ( $data['list_news'] as $value) {
				         ...
				         echo "<link><?php echo base_url();?>tintuc</link>\n";  
