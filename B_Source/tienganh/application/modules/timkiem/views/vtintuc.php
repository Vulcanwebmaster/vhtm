...
<div id="center">
	<ul id="aboutus-menu">
		...
		<!--<li class="aboutus-item">
			<img alt="" src="<?php echo base_url();?>assets/trungtam-tienganh/images/chanhleo.jpg"/>
			...
			<div style="width:566px; float:left; border:1px solid #ddd; padding:5px 5px; margin:5px 0px;">
	            <img width="122" height="86" style="float:left; margin-right:20px;" src="<?php echo base_url();?>assets/trungtam-tienganh/images/chanhleo.jpg">    
