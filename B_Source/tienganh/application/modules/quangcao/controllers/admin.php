<?php
	class Admin extends Admin_Controller
	{
		...
		//=============================================
			...
			//=============================================
				$data['info']=$this->Mquangcao->getRowByColumn('quangcao','id','1');
				$data['title']='Sửa quangcao ảnh';
				$data['bcCurrent']='quangcao ảnh';
		...
		function edit($id=1)
		{
			...
			{
				$input=$this->_input();
				if ($this->Mquangcao->updateRowByColumn('quangcao','id',$id,$input))
				{
			...
			{
				$data['info']=$this->Mquangcao->getRowByColumn('quangcao','id',$id);
