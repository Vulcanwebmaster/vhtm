		...
		?>	
<form method="post" action="<?php echo base_url();?>slidefooter/admin/edit/<?php echo $info->id;?>">	
	<article class="module width_3_quarter" style="width:95%;">
		...
		<div class="tab_container">
			...
			<div id="tab1" class="tab_content">
				...
				<fieldset>
					<label>Slide ảnh 5</label>
					<?php echo $this->ckeditor->editor('anh5',$info->anh5,$config);?>
				</fieldset>
			</div>
