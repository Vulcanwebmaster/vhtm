<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tin_tuc.aspx.cs" Inherits="NIW.Sites.tin_tuc" %>

<%@ Register src="tin_tuc_item.ascx" tagname="tin_tuc_item" tagprefix="uc1" %>
...
<!--Nội dung trái-->
        <div id="div_left" style="float: left" runat="server">  
