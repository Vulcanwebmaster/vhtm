<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Gioi_thieu.aspx.cs" Inherits="NIW_Website_2.Sites.Gioi_thieu" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head profile="http://gmpg.org/xfn/11">
    <!-- basic meta tags -->
    <meta http-equiv="Content-Type" content="Giới thiệu công ty thiết kế website NIW" />
    <meta name="robots" content="Giới thiệu công ty thiết kế website NIW" />
    <!-- title -->
    <title runat="server" id="title">NIW &#8211; Giới thiệu</title>
    <!-- stylesheets -->
    ...
    <meta name='robots' content ="Introduction"/>
    ...
    <link rel='canonical' href='Gioi_thieu.aspx' />
    ...
    <div id='wrap_all' class='stretched'>
        ...
        <div class="wrapper wrapper_heading ie6fix" id="wrapper_featured_area">
            ...
            <div class="center" style="margin-top: 10px; font-family: Verdana;">
                <h2 runat="server" id="Vai_net_chinh">
                    Vài nét chính công ty NIW</h2>
            </div>
        </div>
        ...
        <div class="wrapper" id='wrapper_main'>
            <div class="center">
                <div id="main">
                    <div class='content'>
                        <div class="entry">
                            <h1 class="siteheading" runat="server" id="Loi_gioi_thieu">Lời giới thiệu</h1>
