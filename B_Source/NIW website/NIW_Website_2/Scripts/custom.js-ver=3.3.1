...
{	
	...
	if(autolink)
	{
		jQuery('a[href$=jpg], a[href$=png], a[href$=gif], a[href$=jpeg], a[href$=".mov"] , a[href$=".swf"] , a[href*="http://www.kriesi.at/themes/avisio/wp-content/themes/avisio/js/vimeo.com"] , a[href*="http://www.kriesi.at/themes/avisio/wp-content/themes/avisio/js/youtube.com"]').each(function()
		{
...
(function($)
{
	$.fn.kriesi_ajax_form = function(options) 
	{
		var defaults = 
		{
			sendPath: 'http://www.kriesi.at/themes/avisio/wp-content/themes/avisio/js/send.php',
