...
--
-- Host: localhost
-- Generation Time: Jul 15, 2012 at 11:05 AM
...
--
-- Database: `leerober_leerobertsonx`
--
...
DROP TABLE IF EXISTS `n_be_acl_groups`;
...
DROP TABLE IF EXISTS `n_be_acl_permissions`;
...
DROP TABLE IF EXISTS `n_be_acl_permission_actions`;
...
DROP TABLE IF EXISTS `n_be_acl_resources`;
...
DROP TABLE IF EXISTS `n_lee_application`;
...
DROP TABLE IF EXISTS `n_lee_website`;
...
INSERT INTO `n_lee_website` (`id`, `title`, `alias`, `content`) VALUES
...
DROP TABLE IF EXISTS `n_preferences`;
...
(1, 'admin', '0993abd18b04dce02cafde93878540f109592da5', 'admin@gmail.com', 1, 2, NULL, '2012-07-13 13:00:26', '2012-02-22 13:46:09', '2012-03-17 21:56:17');
...
DROP TABLE IF EXISTS `n_user_profiles`;
