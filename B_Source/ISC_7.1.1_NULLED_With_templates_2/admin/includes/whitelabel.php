 ...
 */
$GLOBALS['ISC_CFG']['ProductName'] = 'Unreal Shopping Cart';
 ...
 */
$GLOBALS['ISC_CFG']['ControlPanelTitle'] = "Unreal Shopping Cart Control Panel (%%EDITION%% Edition)";
 ...
 */
$GLOBALS['ISC_CFG']['AdminCopyright'] = 'Powered by Unreal Shopping Cart %%VERSION%% &copy; 2004-'.date('Y').' Interspire Pty. Ltd.';
