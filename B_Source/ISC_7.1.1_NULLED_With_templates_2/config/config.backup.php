<?php
	...
	// Last Updated: 24th Jun 2012 @ 10:37 AM
	...
	$GLOBALS['ISC_CFG']["dbPass"] = 'khongcopass';
	$GLOBALS['ISC_CFG']["dbDatabase"] = 'shoppingcart';
	$GLOBALS['ISC_CFG']["tablePrefix"] = 'isc_';
	$GLOBALS['ISC_CFG']["StoreName"] = 'NIW\'s Shop';
	$GLOBALS['ISC_CFG']["StoreAddress"] = 'http://localhost/ISC_7.1.1_NULLED_With_templates_2/index.php';
	$GLOBALS['ISC_CFG']["LogoType"] = 'text';
	$GLOBALS['ISC_CFG']["StoreLogo"] = '';
	$GLOBALS['ISC_CFG']["ShopPath"] = 'http://localhost/ISC_7.1.1_NULLED_With_templates_2';
	...
	$GLOBALS['ISC_CFG']["template"] = 'Flowers';
	$GLOBALS['ISC_CFG']["SiteColor"] = 'green';
	...
	$GLOBALS['ISC_CFG']["InstallDate"] = 1336374397;
	...
	$GLOBALS['ISC_CFG']["AdminEmail"] = 'lexuantien0311@gmail.com';
	$GLOBALS['ISC_CFG']["OrderEmail"] = 'lexuantien0311@gmail.com';
	...
	$GLOBALS['ISC_CFG']['StoreTimeZone'] = '7';
  ...
  2 => 'Store Credit',
	...
	$GLOBALS['ISC_CFG']["EncryptionToken"] = 'e637ad5fae62c1e6f0ddba70eb0bdd62';
