...
class Lingerie_logo extends LogoMaker
{
	/**
	 * TextFieldCount
	...
	*/
	...
	public function GenerateLogo()
	{
		...
		$t_box = $this->TextBox($this->Text[0], 'SCRIPTIN.ttf', '000000', $textSize, 0, 0);
		...
		if(strlen($this->Text[0]) > 0) {
			...
			$text_position = $this->AddText($this->Text[0], 'SCRIPTIN.ttf', '000000', $textSize, $textLeft, $y_pos);
		}

		if(strlen($this->Text[1]) > 0) {
			// put in our second bit of text
			$text_position2 = $this->AddText($this->Text[1], 'SCRIPTIN.ttf', '000000', $textSize, $text_position['top_right_x']+15, $y_pos);
