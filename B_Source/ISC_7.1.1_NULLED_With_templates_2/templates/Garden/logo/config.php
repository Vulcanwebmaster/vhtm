...
class Garden_logo extends LogoMaker
{
	/**
	 * TextFieldCount
	...
	*/
	...
	public function GenerateLogo()
	{
		...
		$t_box = $this->TextBox($this->Text[0], 'GillSansStd-Bold.otf', '534d02', $textSize, 0, 0);
		...
		if(strlen($this->Text[0]) > 0) {
			...
			$text_position = $this->AddText($this->Text[0], 'GillSansStd-Bold.otf', '534d02', $textSize, $textLeft, $y_pos);
		}

		if(strlen($this->Text[1]) > 0) {
			// put in our second bit of text
			// AddText() - text, font, fontcolor, fontSize (pt), x, y, center on this width
			$text_position2 = $this->AddText($this->Text[1], 'GillSansStd.otf', 'a4b507', $textSize, $text_position['top_right_x']+5, $y_pos);
