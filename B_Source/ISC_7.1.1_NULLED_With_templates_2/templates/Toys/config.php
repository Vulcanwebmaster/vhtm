...
$GLOBALS['TPL_CFG']['HeaderImageElement'] = '#Outer';

// Additional stylesheets to load for this template
$GLOBALS['TPL_CFG']['AdditionalStylesheets'] = array(
	array(
		'stylesheet' => 'Styles/ie6.css',
		'condition' => 'IE 6'
	)
);