...
class WomensShoes_logo extends LogoMaker
{
	/**
	 * TextFieldCount
	...
	*/
	 ...
	 * @var string
	 */
	public $displayBgImg = '../images/red/bg_body.gif';
	...
	public function GenerateLogo()
	{
		...
		$t_box = $this->TextBox($this->Text[0], 'trebuc.ttf', 'FFD770', $textSize, 0, 0);
		...
		if(strlen($this->Text[0]) > 0) {
			...
			$text_position = $this->AddText($this->Text[0], 'trebuc.ttf', 'FFD770', $textSize, $textLeft, $y_pos);
		}

		if(strlen($this->Text[1]) > 0) {
			// put in our second bit of text
			$text_position2 = $this->AddText($this->Text[1], 'trebuc.ttf', 'FFFFFF', $textSize, $textLeft+50, $text_position['bottom_left_y']+30);
