...
namespace Emgu.CV
{
   ...
   {
       public static String ConnectionString = @"Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\Database\Database1.mdf;Integrated Security=True;User Instance=True";
      ...
      public void FindMostSimilarObject(Image<Gray, Byte> image, out int index, out float eigenDistance, out String label,ref int out_index)
      {
      ...
      public String Recognize(Image<Gray, Byte> image,ref int index)
      {
         ...
         int out_index = 0;
         FindMostSimilarObject(image, out index, out eigenDistance, out label,ref out_index);
