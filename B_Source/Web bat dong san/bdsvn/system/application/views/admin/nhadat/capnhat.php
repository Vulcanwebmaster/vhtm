...
<?php
  ...
  echo form_open('nhadats/capnhattin/1/'.$this->uri->segment('4'));
?>
<table class="dangtin">  
    <tr>
        <td>Nhu cầu:</td>
...
?>
<?php
  echo form_open('nhadats/capnhattin/2/'.(int)$this->uri->segment('4'));
?>
 ...
 <table class="tool" cellpadding="0" cellspacing="0">
    <tr>
        <td style="width: 500px;">
            <a href="<?=base_url()?>nhadats/capnhattin/1/<?=(int)$this->uri->segment(4)?>">
...
?>
<?php
  echo form_open('nhadats/capnhattin/3/'.$this->uri->segment('4'));
?>
<div class="bgtitle">
...
<table class="dangtin">   
    ...
    <tr>        
        ...
        <td>
            ...
            <select name="matbang">
                ...
                <option value="m2" <?if($mb=='m2'){echo 'selected="selected"';}?>>m<sup>2</sup></option>
            </select>
            <?=form_error('gia')?>
        </td>        
    </tr>
    <tr>        
        ...
        <td>
            ...
            <input type="text" name="rong" value="<?=$rong?>" style="width: 50px;"> x <input type="text" value="<?=$dai?>" name="dai" style="width: 50px;"> m2            
    ...
    <tr>        
        ...
        <td>
            ...
            <input type="text" name="dientich" value="<?=$buoc1->dientich?>" style="width: 50px;"> m2            
    ...
    <tr>        
        ...
        <td>
            ...
            <input type="checkbox" name="vip" value="1" <?if($vip==1){echo 'checked="checked"';}?>>
            <?=form_error('vip')?>          
        </td>        
    </tr> 
    <tr>        
        ...
        <td>
            ...
            <input type="checkbox" name="bat" value="1" <?if($bat==1){echo 'checked="checked"';}?>>
            <?=form_error('vip')?>          
        </td>        
    </tr>        
    <tr>
...
<table class="tool" cellpadding="0" cellspacing="0">
    <tr>
        <td style="width: 500px;">
            <a href="<?=base_url()?>nhadats/capnhattin/2/<?=(int)$this->uri->segment(4)?>">
                <img src="<?=base_url()?>skins/quaylai.png" alt=""> Quay lại
            </a>
        </td>
        <td>
...
<form action="<?=base_url()?>nhadats/uploadfile/<?=$this->uri->segment('4')?>" method="post" onsubmit="return AIM.submit(this, {'onStart' : startCallback, 'onComplete' : completeCallback})" enctype="multipart/form-data">
        ...
        <div id="sub2div" > 
            ...
            <?if($list){?>
                ...
                <li class="record" style="margin-top: 20px;">
                    ...
                    <div><a  href="javascript:;" class="delbutton" id="<?=$rs1->id?>">Xóa</a></div>
                </li>
                <?endforeach;?>
                </ul>
            <?}?>
...
<?=form_open('nhadats/capnhattin/4/'.$this->uri->segment(4))?>
<table class="tool" cellpadding="0" cellspacing="0">
    <tr>
        <td style="width: 400px;">
            <a href="<?=base_url()?>nhadats/capnhattin/3/<?=(int)$this->uri->segment(4)?>">
                <img src="<?=base_url()?>skins/quaylai.png" alt=""> Quay lại
            </a>
        </td>
        <td>
