...
<link rel="stylesheet" type="text/css" href="<?=base_url()?>system/application/views/theme/site/<?=$this->site_library->get_default_template()?>/css/tailieu.css">
...
<div class="wrap"> 
    <div class="header clearfix">
        <div class="headtop">
             <div class="logo">
                <img src="<?=base_url()?>skins/ebook.png" alt="">  
             </div>
             <div class="adv">
             <?=$this->load->view('modules/tnd_app/index')?> 
                   <?=$this->load->view('modules/tnd_quangcao/tailieu_banner')?>
             </div>
        </div>
