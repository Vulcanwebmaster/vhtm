...
<title><?=$title?> - Diễn Đàn - <?=$this->setting_library->setting['site_name']?></title>  
<link rel="shortcut icon" href="<?=base_url()?>skins/favicon.ico" type="image/x-icon" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>system/application/views/theme/site/<?=$this->site_library->get_default_template()?>/css/diendan.css">
...
<div id="wrap_header">
    <div class="headforum">
        <div class="logo">
            <img src="<?=base_url()?>skins/forum.png" alt="">
        </div>
        <div class="quangcao">
    ...
    <div>
        <div id="colortab" style="float: left;width: 800px;padding-left: 20px;" class="ddcolortabs clearfix">
            <ul>
            <li><a href="<?=base_url()?>"><span>Đèn Đom Đóm</span></a></li>
            <li><a href="<?=base_url()?>tintuc.html"><span>Tin tức</span></a></li>
            <li><a href="<?=base_url()?>diendan.html"><span>Diễn đàn</span></a></li> 
            <li><a href="<?=base_url()?>nhac.html"><span>Nghe nhạc Online</span></a></li> 
            <li><a href="<?=base_url()?>tailieu.html"><span>Tài liệu</span></a></li>
            <li><a href="<?=base_url()?>anhdep.html"><span>Ảnh đẹp</span></a></li>           
            
            <li><a href="<?=base_url()?>phim.html"><span>Phim</span></a></li>
            <li><a href="#"><span>Rao vặt</span></a></li>

            </ul>
        </div>
        <div style="float: right;width: 160px;text-align: right;margin-right:20px;">
             <?=$this->load->view('modules/tnd_cpanelforum/index')?>  
        </div>    
    </div>
</div>
