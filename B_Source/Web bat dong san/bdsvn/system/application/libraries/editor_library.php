      ...
      function editor_advanced($name,$value,$error){
          ...
          $data .='
            tinyMCE.init({
                ...
                theme_advanced_buttons2 : "bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,anchor,image,cleanup,help,code,|,forecolor,backcolor,|,emotions,iespell,media,advhr,|,ltr,rtl,|,fullscreen",
                ...
                content_css : "'.base_url().'skins/tinymce/js/css/content.css",

                // Drop lists for link/image/media/template dialogs
                template_external_list_url : "'.base_url().'skins/tinymce/js/lists/template_list.js",
                external_link_list_url : "'.base_url().'skins/tinymce/js/lists/link_list.js",
                external_image_list_url : "'.base_url().'skins/tinymce/js/lists/image_list.js",
                media_external_list_url : "'.base_url().'skins/tinymce/js/lists/media_list.js"
