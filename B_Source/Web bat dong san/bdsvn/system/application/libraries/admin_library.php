...
class admin_library
{
    ...
    public function load($page, $data = NULL,$layout=FALSE)
    {
        ...
        if($layout==TRUE){
            ...
            $this->CI->load->view('system/application/views/theme/admin/'.$duongdan.'/skin_'.$layout, $data);
        }else{
            $this->CI->load->view('system/application/views/theme/admin/'.$duongdan.'/skin', $data);
        }        
    }
    
    public function loadadmin($page, $data = NULL){
        $data['page'] = $page;
        $this->CI->load->view('system/application/views/theme/admin/vnit/skin', $data);        
    }
