...
(function(){var b={};
var a={};
function c(d){b=d["http://www.google.com/friendconnect/script/core.util"]||{}
}if(gadgets.config){gadgets.config.register("http://www.google.com/friendconnect/script/core.util",null,c)
...
/* [end] feature=rpc */
gadgets.config.init({"rpc":{"commSwf":"xpc.swf"/*tpa=http://xpc.googleusercontent.com/gadgets/xpc.swf*/,"passReferrer":"p2c:query","parentRelayUrl":"http://www.google.com/rpc_relay.html"}});
...
fcDc[fc].Pa=function(a){return(a=this.zb[a.id])?fck[fcz](a):fcd};var fc8=function(a){fc6[fcG](this,a);a=a||{};this.aa=a.view||"profile"};fcV(fc8,fc6);fc8[fc].rb="http://www.google.com/friendconnect/script/canvas.html";fc8[fc].xb="/friendconnect/embed/";var fcBc=function(){var a="1"==fcf[fcK][fcC]().canvas||"1"==fcf[fcK][fcC]().embed,b=fcd;a&&(b=fcf[fcK][fcC]().caller);b||(a=fck[fcB],b=a.search[fcw](/([&?]?)psinvite=[^&]*(&?)/,function(a,b,e){return e?b:""}),b=a.protocol+"//"http://www.google.com/friendconnect/script/+a.hostname+(a.port?":"+a.port:"")+a.pathname+b);return b};
...
google.friendconnect.container.setDateStamp_('1369ba59d98');