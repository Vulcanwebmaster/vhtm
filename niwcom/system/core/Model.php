...
class CI_Model {
	...
	function getRowByColumn($tableName='',$columnName='',$value='')
 	 ...
 	 function getListOffset123($tableName='',$offset='', $columnName='', $value='')
	 {
 	 ...
 	 function getListOffsetODB($tableName='',$offset='',$colum='',$orderby='',$columnName='',$value='')
	 {
	 	$this->db->where($columnName,$value);
	 	$this->db->order_by($colum, $orderby); 
	 	$ds=$this->db->get($tableName,$offset);
	 	$list=array();
	 	foreach($ds->result() as $item)
	 	{
 	 ...
 	 function getListFullODB($tableName='',$offset='',$columnName='',$orderby='')
	 {
	 ...
	 function getListByColumn2($tableName='',$columnName='',$value='')
	 {
	 	$this->db->where($columnName,$value);
 	 ...
 	 function getListByColumnODB($tableName='',$columnName='',$value='',$colum2='',$orderby='')
	 {
	 	$this->db->where($columnName,$value);
		$this->db->order_by($colum2, $orderby); 
	 	$ds=$this->db->get($tableName);
	 	$list=array();
	 	foreach($ds->result() as $item)
	 	{
	...
	function getListWithOutColumn($tableName='',$columnName='',$value='')
	 ...
	 function insertNewRow2($tableName='',$input)
	 {
	 	if ($this->db->insert($tableName,$input))
